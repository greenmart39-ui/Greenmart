...
const ps=[
    {name:'බාස්මතී සහල් 1kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:320,wholesalePrice:280,costPrice:250,stock:2500,lowStock:100,image:null},
    {name:'බාස්මතී සහල් 5kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:1450,wholesalePrice:1280,costPrice:1150,stock:1800,lowStock:50,image:null},
    {name:'සාම්බා සහල් 1kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:190,wholesalePrice:165,costPrice:145,stock:3000,lowStock:150,image:null},
    {name:'සාම්බා සහල් 5kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:920,wholesalePrice:800,costPrice:700,stock:2000,lowStock:80,image:null},
    {name:'නාඩු සහල් 1kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:175,wholesalePrice:150,costPrice:130,stock:3500,lowStock:150,image:null},
    {name:'නාඩු සහල් 5kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:840,wholesalePrice:720,costPrice:630,stock:2200,lowStock:80,image:null},
    {name:'රතු හාල් 1kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:165,wholesalePrice:140,costPrice:120,stock:2800,lowStock:100,image:null},
    {name:'සුදු කැකුළු සහල් 1kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:160,wholesalePrice:138,costPrice:118,stock:2600,lowStock:100,image:null},
    {name:'රතු නාඩු සහල් 5kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:800,wholesalePrice:690,costPrice:600,stock:1500,lowStock:60,image:null},
    {name:'ගොයම් පිටි 1kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:145,wholesalePrice:122,costPrice:105,stock:3000,lowStock:150,image:null},
    {name:'ගොයම් පිටි 5kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:680,wholesalePrice:580,costPrice:500,stock:1500,lowStock:60,image:null},
    {name:'සහල් පිටි 500g',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:100,image:null},
    {name:'ඉරිඟු පිටි 500g',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:85,wholesalePrice:70,costPrice:58,stock:1800,lowStock:80,image:null},
    {name:'රතු දාල් 500g',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:180,wholesalePrice:155,costPrice:135,stock:2500,lowStock:100,image:null},
    {name:'මුං ඇට 500g',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:190,wholesalePrice:162,costPrice:140,stock:2200,lowStock:100,image:null},
    {name:'උළුහාල් 500g',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:185,wholesalePrice:158,costPrice:138,stock:2000,lowStock:80,image:null},
    {name:'කඩල 500g',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:210,wholesalePrice:178,costPrice:155,stock:1800,lowStock:80,image:null},
    {name:'ඕට්ස් 500g',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:220,wholesalePrice:188,costPrice:165,stock:2000,lowStock:80,image:null},
    {name:'සෙමොලීනා 500g',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:110,wholesalePrice:92,costPrice:78,stock:2500,lowStock:100,image:null},
    {name:'ඉදිආප්ප පිටි 500g',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:125,wholesalePrice:105,costPrice:88,stock:2000,lowStock:80,image:null},
    {name:'පොල් පිටි 250g',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:98,wholesalePrice:82,costPrice:68,stock:1500,lowStock:60,image:null},
    {name:'ක්‍රීම් ඔෆ් රයිස් 500g',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:135,wholesalePrice:112,costPrice:95,stock:1800,lowStock:80,image:null},
    {name:'රෝල්ඩ් ඕට්ස් 1kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1200,lowStock:50,image:null},
    {name:'ක්විකර් ඕට්ස් 500g',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'ලා ධාන්‍ය 500g',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:165,wholesalePrice:140,costPrice:120,stock:2000,lowStock:80,image:null},
    {name:'කළු ඇට 500g',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:175,wholesalePrice:148,costPrice:128,stock:1800,lowStock:80,image:null},
    {name:'සෝයා ඇට 500g',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:155,wholesalePrice:130,costPrice:112,stock:2000,lowStock:80,image:null},
    {name:'රතු රාජ්‍යමාෂ 500g',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1800,lowStock:80,image:null},
    {name:'කොළ ධාන්‍ය 500g',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:185,wholesalePrice:158,costPrice:138,stock:1800,lowStock:80,image:null},
    {name:'සහල් නූඩ්ල්ස් 250g',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:125,wholesalePrice:105,costPrice:88,stock:2000,lowStock:80,image:null},
    {name:'නැවුම් කිරි 1L',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:195,wholesalePrice:168,costPrice:145,stock:1500,lowStock:80,image:null},
    {name:'නැවුම් කිරි 500ml',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:105,wholesalePrice:88,costPrice:75,stock:2000,lowStock:100,image:null},
    {name:'Full Cream කිරිපිටි 400g',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:850,wholesalePrice:730,costPrice:640,stock:1200,lowStock:50,image:null},
    {name:'Full Cream කිරිපිටි 1kg',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:1950,wholesalePrice:1680,costPrice:1480,stock:800,lowStock:30,image:null},
    {name:'Low Fat කිරිපිටි 400g',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:820,wholesalePrice:700,costPrice:615,stock:1100,lowStock:50,image:null},
    {name:'සාදාගන්නා 200g',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:85,wholesalePrice:70,costPrice:58,stock:1800,lowStock:80,image:null},
    {name:'පළතුරු සාදාගන්නා 200g',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:95,wholesalePrice:78,costPrice:65,stock:1600,lowStock:80,image:null},
    {name:'චෙඩාර් ගෝමර 200g',category:'කිරිජන්‍ය',icon:'🧀',retailPrice:520,wholesalePrice:445,costPrice:390,stock:800,lowStock:30,image:null},
    {name:'බටර් 200g',category:'කිරිජන්‍ය',icon:'🧈',retailPrice:380,wholesalePrice:325,costPrice:285,stock:1000,lowStock:40,image:null},
    {name:'මාගරීන් 250g',category:'කිරිජන්‍ය',icon:'🧈',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1200,lowStock:50,image:null},
    {name:'ක්‍රීම් 200ml',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:30,image:null},
    {name:'Condensed කිරි 397g',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:310,wholesalePrice:265,costPrice:230,stock:1200,lowStock:50,image:null},
    {name:'Evaporated කිරි 410g',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:295,wholesalePrice:252,costPrice:220,stock:1200,lowStock:50,image:null},
    {name:'කිරි සාම්බා 200g',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'ස්ට්‍රෝබෙරි කිරි 200ml',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:120,wholesalePrice:100,costPrice:85,stock:2000,lowStock:80,image:null},
    {name:'චොකලට් කිරි 200ml',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:125,wholesalePrice:105,costPrice:88,stock:2000,lowStock:80,image:null},
    {name:'ස්කිම් මිල්ක් 1L',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:185,wholesalePrice:158,costPrice:138,stock:1200,lowStock:50,image:null},
    {name:'ඕගනික් කිරි 1L',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:30,image:null},
    {name:'ක්‍රීම් චීස් 100g',category:'කිරිජන්‍ය',icon:'🧀',retailPrice:420,wholesalePrice:358,costPrice:315,stock:600,lowStock:25,image:null},
    {name:'කෝටේජ් ෆ්‍රොම් 200g',category:'කිරිජන්‍ය',icon:'🧀',retailPrice:295,wholesalePrice:252,costPrice:220,stock:700,lowStock:30,image:null},
    {name:'Coca-Cola 330ml',category:'පාන',icon:'🥤',retailPrice:120,wholesalePrice:98,costPrice:82,stock:3000,lowStock:150,image:null},
    {name:'Coca-Cola 1.5L',category:'පාන',icon:'🥤',retailPrice:250,wholesalePrice:212,costPrice:182,stock:2000,lowStock:100,image:null},
    {name:'Pepsi 330ml',category:'පාන',icon:'🥤',retailPrice:115,wholesalePrice:95,costPrice:80,stock:2800,lowStock:150,image:null},
    {name:'Sprite 330ml',category:'පාන',icon:'🥤',retailPrice:115,wholesalePrice:95,costPrice:80,stock:2500,lowStock:120,image:null},
    {name:'Fanta 330ml',category:'පාන',icon:'🥤',retailPrice:115,wholesalePrice:95,costPrice:80,stock:2500,lowStock:120,image:null},
    {name:'නළ වතුර 500ml',category:'පාන',icon:'💧',retailPrice:40,wholesalePrice:30,costPrice:22,stock:5000,lowStock:200,image:null},
    {name:'නළ වතුර 1.5L',category:'පාන',icon:'💧',retailPrice:80,wholesalePrice:62,costPrice:50,stock:4000,lowStock:200,image:null},
    {name:'ඔරෙන්ජ් ජූස් 1L',category:'පාන',icon:'🍊',retailPrice:320,wholesalePrice:272,costPrice:238,stock:1200,lowStock:60,image:null},
    {name:'ඇපල් ජූස් 1L',category:'පාන',icon:'🍎',retailPrice:340,wholesalePrice:288,costPrice:252,stock:1100,lowStock:50,image:null},
    {name:'අඹ ජූස් 1L',category:'පාන',icon:'🥭',retailPrice:295,wholesalePrice:250,costPrice:218,stock:1100,lowStock:50,image:null},
    {name:'Nestea Iced Tea 1L',category:'පාන',icon:'🍵',retailPrice:285,wholesalePrice:242,costPrice:210,stock:1000,lowStock:50,image:null},
    {name:'Milo 400g',category:'පාන',icon:'🥤',retailPrice:580,wholesalePrice:495,costPrice:435,stock:1200,lowStock:50,image:null},
    {name:'Milo 1kg',category:'පාන',icon:'🥤',retailPrice:1250,wholesalePrice:1070,costPrice:940,stock:800,lowStock:30,image:null},
    {name:'Horlicks 400g',category:'පාන',icon:'🥤',retailPrice:560,wholesalePrice:478,costPrice:420,stock:1000,lowStock:40,image:null},
    {name:'Nescafe 100g',category:'පාන',icon:'☕',retailPrice:720,wholesalePrice:615,costPrice:540,stock:1000,lowStock:40,image:null},
    {name:'හරිත තේ 25pk',category:'පාන',icon:'🍵',retailPrice:185,wholesalePrice:155,costPrice:135,stock:1500,lowStock:60,image:null},
    {name:'සිලෝන් තේ 200g',category:'පාන',icon:'🍵',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1500,lowStock:60,image:null},
    {name:'3in1 කෝෆී 30pk',category:'පාන',icon:'☕',retailPrice:420,wholesalePrice:355,costPrice:310,stock:1200,lowStock:50,image:null},
    {name:'Energy Drink 250ml',category:'පාන',icon:'🥤',retailPrice:180,wholesalePrice:150,costPrice:128,stock:2000,lowStock:100,image:null},
    {name:'Ovaltine 400g',category:'පාන',icon:'🥤',retailPrice:520,wholesalePrice:442,costPrice:388,stock:1000,lowStock:40,image:null},
    {name:'Bournvita 400g',category:'පාන',icon:'🥤',retailPrice:540,wholesalePrice:460,costPrice:404,stock:900,lowStock:40,image:null},
    {name:'රාස්පබෙරි ජූස් 1L',category:'පාන',icon:'🍇',retailPrice:310,wholesalePrice:265,costPrice:230,stock:900,lowStock:40,image:null},
    {name:'ගිනිදර ජල 500ml',category:'පාන',icon:'💧',retailPrice:120,wholesalePrice:100,costPrice:85,stock:2500,lowStock:100,image:null},
    {name:'ලෙමන් ජූස් 500ml',category:'පාන',icon:'🍋',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:50,image:null},
    {name:'Sprite 1.5L',category:'පාන',icon:'🥤',retailPrice:240,wholesalePrice:200,costPrice:172,stock:1500,lowStock:80,image:null},
    {name:'Lion Lager 330ml',category:'පාන',icon:'🍺',retailPrice:180,wholesalePrice:150,costPrice:128,stock:3000,lowStock:150,image:null},
    {name:'Anchor Beer 500ml',category:'පාන',icon:'🍺',retailPrice:250,wholesalePrice:212,costPrice:182,stock:2000,lowStock:100,image:null},
    {name:'Red Bull 250ml',category:'පාන',icon:'🥤',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1500,lowStock:60,image:null},
    {name:'Gatorade 500ml',category:'පාන',icon:'🥤',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'ශ්‍රී ලංකා ආකාශ ජූස් 1L',category:'පාන',icon:'🍹',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:50,image:null},
    {name:'Lays Chips 100g',category:'ස්නැක්ස්',icon:'🍿',retailPrice:195,wholesalePrice:165,costPrice:142,stock:2000,lowStock:80,image:null},
    {name:'Pringles 165g',category:'ස්නැක්ස්',icon:'🍿',retailPrice:480,wholesalePrice:408,costPrice:358,stock:1200,lowStock:50,image:null},
    {name:'Ritz Crackers 200g',category:'ස්නැක්ස්',icon:'🍪',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'Marie Biscuits 200g',category:'ස්නැක්ස්',icon:'🍪',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2500,lowStock:100,image:null},
    {name:'Chocolate Biscuits 200g',category:'ස්නැක්ස්',icon:'🍪',retailPrice:185,wholesalePrice:158,costPrice:138,stock:2000,lowStock:80,image:null},
    {name:'Bourbon Biscuits 200g',category:'ස්නැක්ස්',icon:'🍪',retailPrice:165,wholesalePrice:140,costPrice:120,stock:2000,lowStock:80,image:null},
    {name:'Cadbury Chocolate 95g',category:'ස්නැක්ස්',icon:'🍫',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1500,lowStock:60,image:null},
    {name:'Kit Kat 40g',category:'ස්නැක්ස්',icon:'🍫',retailPrice:145,wholesalePrice:122,costPrice:105,stock:3000,lowStock:150,image:null},
    {name:'රෝස්ට්ඩ් කජු 100g',category:'ස්නැක්ස්',icon:'🥜',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1500,lowStock:60,image:null},
    {name:'රෝස්ට්ඩ් රටකජු 200g',category:'ස්නැක්ස්',icon:'🥜',retailPrice:155,wholesalePrice:130,costPrice:112,stock:2000,lowStock:80,image:null},
    {name:'Mixed Nuts 200g',category:'ස්නැක්ස්',icon:'🥜',retailPrice:420,wholesalePrice:355,costPrice:310,stock:1200,lowStock:50,image:null},
    {name:'මුරුක්කු 200g',category:'ස්නැක්ස්',icon:'🍿',retailPrice:165,wholesalePrice:138,costPrice:118,stock:2000,lowStock:80,image:null},
    {name:'Chilli Cashews 100g',category:'ස්නැක්ස්',icon:'🥜',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'Popcorn 100g',category:'ස්නැක්ස්',icon:'🍿',retailPrice:145,wholesalePrice:120,costPrice:102,stock:2000,lowStock:80,image:null},
    {name:'Gummy Bears 100g',category:'ස්නැක්ස්',icon:'🍬',retailPrice:120,wholesalePrice:98,costPrice:82,stock:2000,lowStock:80,image:null},
    {name:'Toffee 100g',category:'ස්නැක්ස්',icon:'🍬',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2500,lowStock:100,image:null},
    {name:'සරිමෝ 200g',category:'ස්නැක්ස්',icon:'🍿',retailPrice:155,wholesalePrice:130,costPrice:112,stock:2000,lowStock:80,image:null},
    {name:'Potato Wedges 200g',category:'ස්නැක්ස්',icon:'🍟',retailPrice:185,wholesalePrice:158,costPrice:138,stock:1500,lowStock:60,image:null},
    {name:'ඉඟුරු රස කෑම 100g',category:'ස්නැක්ස්',icon:'🍿',retailPrice:110,wholesalePrice:92,costPrice:78,stock:2000,lowStock:80,image:null},
    {name:'Twix 50g',category:'ස්නැක්ස්',icon:'🍫',retailPrice:155,wholesalePrice:130,costPrice:112,stock:2500,lowStock:100,image:null},
    {name:'Snickers 50g',category:'ස්නැක්ස්',icon:'🍫',retailPrice:155,wholesalePrice:130,costPrice:112,stock:2500,lowStock:100,image:null},
    {name:'Mars Bar 50g',category:'ස්නැක්ස්',icon:'🍫',retailPrice:155,wholesalePrice:130,costPrice:112,stock:2500,lowStock:100,image:null},
    {name:'Digestive Biscuits 200g',category:'ස්නැක්ස්',icon:'🍪',retailPrice:195,wholesalePrice:165,costPrice:142,stock:2000,lowStock:80,image:null},
    {name:'Oreo 200g',category:'ස්නැක්ස්',icon:'🍪',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'Chocolate Wafer 200g',category:'ස්නැක්ස්',icon:'🍪',retailPrice:175,wholesalePrice:148,costPrice:128,stock:2000,lowStock:80,image:null},
    {name:'Fruit Cake 200g',category:'ස්නැක්ස්',icon:'🎂',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1200,lowStock:50,image:null},
    {name:'Sesame Snack 100g',category:'ස්නැක්ස්',icon:'🍿',retailPrice:120,wholesalePrice:100,costPrice:85,stock:2000,lowStock:80,image:null},
    {name:'Katta Sambol Chips 100g',category:'ස්නැක්ස්',icon:'🍿',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2500,lowStock:100,image:null},
    {name:'Chilli Crisps 100g',category:'ස්නැක්ස්',icon:'🍿',retailPrice:165,wholesalePrice:140,costPrice:120,stock:2000,lowStock:80,image:null},
    {name:'Coconut Biscuits 200g',category:'ස්නැක්ස්',icon:'🍪',retailPrice:155,wholesalePrice:130,costPrice:112,stock:2000,lowStock:80,image:null},
    {name:'තක්කාලි 500g',category:'එළවළු',icon:'🍅',retailPrice:130,wholesalePrice:105,costPrice:85,stock:1000,lowStock:50,image:null},
    {name:'ඇල 1kg',category:'එළවළු',icon:'🥔',retailPrice:180,wholesalePrice:150,costPrice:128,stock:1200,lowStock:60,image:null},
    {name:'ළූනු 1kg',category:'එළවළු',icon:'🧅',retailPrice:150,wholesalePrice:125,costPrice:105,stock:1500,lowStock:80,image:null},
    {name:'ලීක්ස් 250g',category:'එළවළු',icon:'🥬',retailPrice:95,wholesalePrice:78,costPrice:65,stock:800,lowStock:40,image:null},
    {name:'කැරට් 500g',category:'එළවළු',icon:'🥕',retailPrice:145,wholesalePrice:120,costPrice:100,stock:1000,lowStock:50,image:null},
    {name:'වම්බටු 500g',category:'එළවළු',icon:'🍆',retailPrice:110,wholesalePrice:90,costPrice:75,stock:900,lowStock:40,image:null},
    {name:'ලාබු 500g',category:'එළවළු',icon:'🎃',retailPrice:90,wholesalePrice:72,costPrice:60,stock:1000,lowStock:50,image:null},
    {name:'කරවිල 500g',category:'එළවළු',icon:'🥬',retailPrice:115,wholesalePrice:95,costPrice:78,stock:800,lowStock:40,image:null},
    {name:'බෝංචි 250g',category:'එළවළු',icon:'🫘',retailPrice:105,wholesalePrice:85,costPrice:70,stock:900,lowStock:40,image:null},
    {name:'මුරුංගා 250g',category:'එළවළු',icon:'🌿',retailPrice:95,wholesalePrice:78,costPrice:65,stock:700,lowStock:30,image:null},
    {name:'හරිත මිරිස් 100g',category:'එළවළු',icon:'🌶',retailPrice:65,wholesalePrice:52,costPrice:42,stock:1200,lowStock:50,image:null},
    {name:'බෙල් පෙප්පර් 250g',category:'එළවළු',icon:'🫑',retailPrice:120,wholesalePrice:98,costPrice:82,stock:800,lowStock:35,image:null},
    {name:'බණ්ඩක්කා 250g',category:'එළවළු',icon:'🥬',retailPrice:98,wholesalePrice:80,costPrice:66,stock:800,lowStock:35,image:null},
    {name:'සුදුළූනු 100g',category:'එළවළු',icon:'🧄',retailPrice:120,wholesalePrice:98,costPrice:82,stock:1200,lowStock:50,image:null},
    {name:'ඉගුරු 100g',category:'එළවළු',icon:'🫚',retailPrice:110,wholesalePrice:90,costPrice:75,stock:1200,lowStock:50,image:null},
    {name:'මිශ්‍ර සලාද 200g',category:'එළවළු',icon:'🥗',retailPrice:165,wholesalePrice:140,costPrice:120,stock:600,lowStock:25,image:null},
    {name:'ස්පිනාච් 200g',category:'එළවළු',icon:'🥬',retailPrice:110,wholesalePrice:90,costPrice:75,stock:700,lowStock:30,image:null},
    {name:'ෆ්‍රෙෂ් කෝරි ඇල 500g',category:'එළවළු',icon:'🥦',retailPrice:195,wholesalePrice:165,costPrice:142,stock:800,lowStock:35,image:null},
    {name:'ශිතල ගෝවා 500g',category:'එළවළු',icon:'🥬',retailPrice:110,wholesalePrice:90,costPrice:75,stock:900,lowStock:40,image:null},
    {name:'ජිකාමා 500g',category:'එළවළු',icon:'🥬',retailPrice:95,wholesalePrice:78,costPrice:65,stock:700,lowStock:30,image:null},
    {name:'රාඩිශ් 250g',category:'එළවළු',icon:'🥬',retailPrice:80,wholesalePrice:65,costPrice:54,stock:800,lowStock:35,image:null},
    {name:'ගෝවා 500g',category:'එළවළු',icon:'🥬',retailPrice:100,wholesalePrice:82,costPrice:68,stock:1000,lowStock:50,image:null},
    {name:'කොළ ජීවන් 100g',category:'එළවළු',icon:'🌿',retailPrice:65,wholesalePrice:52,costPrice:42,stock:1500,lowStock:60,image:null},
    {name:'සෙලරි 100g',category:'එළවළු',icon:'🌿',retailPrice:95,wholesalePrice:78,costPrice:65,stock:1000,lowStock:50,image:null},
    {name:'ලිලී ළූනු 100g',category:'එළවළු',icon:'🧅',retailPrice:75,wholesalePrice:62,costPrice:52,stock:1200,lowStock:50,image:null},
    {name:'කොළ කෙසෙල් ගෙඩි 500g',category:'එළවළු',icon:'🥬',retailPrice:90,wholesalePrice:72,costPrice:60,stock:800,lowStock:35,image:null},
    {name:'ශිතල ඇල 500g',category:'එළවළු',icon:'🥔',retailPrice:145,wholesalePrice:120,costPrice:100,stock:1000,lowStock:50,image:null},
    {name:'රෝස් මේරි 50g',category:'එළවළු',icon:'🌿',retailPrice:180,wholesalePrice:152,costPrice:132,stock:500,lowStock:20,image:null},
    {name:'ලොනු ගෝවා 500g',category:'එළවළු',icon:'🥬',retailPrice:115,wholesalePrice:95,costPrice:78,stock:800,lowStock:35,image:null},
    {name:'හිරු රතු සලාද 200g',category:'එළවළු',icon:'🥗',retailPrice:150,wholesalePrice:125,costPrice:108,stock:600,lowStock:25,image:null},
    {name:'කෙසෙල් (කොළ)',category:'පළතුරු',icon:'🍌',retailPrice:95,wholesalePrice:75,costPrice:62,stock:1000,lowStock:50,image:null},
    {name:'ඇපල් 500g',category:'පළතුරු',icon:'🍎',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:40,image:null},
    {name:'දොඩම් 500g',category:'පළතුරු',icon:'🍊',retailPrice:180,wholesalePrice:150,costPrice:128,stock:900,lowStock:40,image:null},
    {name:'අඹ 500g',category:'පළතුරු',icon:'🥭',retailPrice:220,wholesalePrice:185,costPrice:162,stock:700,lowStock:30,image:null},
    {name:'ගස්ලබු 500g',category:'පළතුරු',icon:'🍈',retailPrice:145,wholesalePrice:120,costPrice:100,stock:700,lowStock:30,image:null},
    {name:'අන්නාසි',category:'පළතුරු',icon:'🍍',retailPrice:200,wholesalePrice:168,costPrice:145,stock:600,lowStock:25,image:null},
    {name:'ෆෘෆ් 1kg',category:'පළතුරු',icon:'🍉',retailPrice:110,wholesalePrice:88,costPrice:72,stock:800,lowStock:35,image:null},
    {name:'මිදි 500g',category:'පළතුරු',icon:'🍇',retailPrice:380,wholesalePrice:322,costPrice:282,stock:500,lowStock:20,image:null},
    {name:'ස්ට්‍රෝබෙරි 250g',category:'පළතුරු',icon:'🍓',retailPrice:320,wholesalePrice:272,costPrice:238,stock:400,lowStock:20,image:null},
    {name:'රාම්බුටාන්',category:'පළතුරු',icon:'🍒',retailPrice:280,wholesalePrice:238,costPrice:208,stock:500,lowStock:20,image:null},
    {name:'දුරියාන් 500g',category:'පළතුරු',icon:'🍈',retailPrice:450,wholesalePrice:382,costPrice:335,stock:300,lowStock:15,image:null},
    {name:'ලිචි 250g',category:'පළතුරු',icon:'🍒',retailPrice:320,wholesalePrice:272,costPrice:238,stock:400,lowStock:20,image:null},
    {name:'ප්ලම් 500g',category:'පළතුරු',icon:'🍑',retailPrice:380,wholesalePrice:322,costPrice:282,stock:400,lowStock:20,image:null},
    {name:'කිවි 250g',category:'පළතුරු',icon:'🥝',retailPrice:320,wholesalePrice:272,costPrice:238,stock:400,lowStock:20,image:null},
    {name:'පෙයාර් 500g',category:'පළතුරු',icon:'🍐',retailPrice:280,wholesalePrice:238,costPrice:208,stock:500,lowStock:20,image:null},
    {name:'දෙල් 500g',category:'පළතුරු',icon:'🍈',retailPrice:195,wholesalePrice:165,costPrice:142,stock:600,lowStock:25,image:null},
    {name:'ද්‍රාක්ෂා 500g',category:'පළතුරු',icon:'🍇',retailPrice:420,wholesalePrice:358,costPrice:315,stock:400,lowStock:20,image:null},
    {name:'ආවෝකැඩෝ',category:'පළතුරු',icon:'🥑',retailPrice:280,wholesalePrice:238,costPrice:208,stock:300,lowStock:15,image:null},
    {name:'ක්‍රීම් ඇපල්',category:'පළතුරු',icon:'🍏',retailPrice:320,wholesalePrice:272,costPrice:238,stock:400,lowStock:20,image:null},
    {name:'ගොනා',category:'පළතුරු',icon:'🍊',retailPrice:150,wholesalePrice:125,costPrice:108,stock:600,lowStock:25,image:null},
    {name:'ස්ඩාර් ෆ්‍රූට්',category:'පළතුරු',icon:'🌟',retailPrice:220,wholesalePrice:185,costPrice:162,stock:400,lowStock:20,image:null},
    {name:'මාංගෝස්ටීන්',category:'පළතුරු',icon:'🍈',retailPrice:480,wholesalePrice:408,costPrice:358,stock:300,lowStock:15,image:null},
    {name:'ජැකෆ්‍රූට් 500g',category:'පළතුරු',icon:'🍈',retailPrice:120,wholesalePrice:98,costPrice:82,stock:600,lowStock:25,image:null},
    {name:'කෙසෙල් (ඉදුනු)',category:'පළතුරු',icon:'🍌',retailPrice:110,wholesalePrice:90,costPrice:75,stock:800,lowStock:35,image:null},
    {name:'නාරං',category:'පළතුරු',icon:'🍊',retailPrice:95,wholesalePrice:78,costPrice:65,stock:1000,lowStock:50,image:null},
    {name:'බෙල් ගෙඩි',category:'පළතුරු',icon:'🍈',retailPrice:165,wholesalePrice:140,costPrice:120,stock:600,lowStock:25,image:null},
    {name:'ඩ්‍රැගන් ෆ්‍රූට් 500g',category:'පළතුරු',icon:'🐉',retailPrice:480,wholesalePrice:408,costPrice:358,stock:300,lowStock:15,image:null},
    {name:'Passion Fruit 250g',category:'පළතුරු',icon:'🍈',retailPrice:320,wholesalePrice:272,costPrice:238,stock:350,lowStock:15,image:null},
    {name:'ලෙමන් 100g',category:'පළතුරු',icon:'🍋',retailPrice:95,wholesalePrice:78,costPrice:65,stock:1200,lowStock:50,image:null},
    {name:'ලයිම් 100g',category:'පළතුරු',icon:'🍋',retailPrice:90,wholesalePrice:72,costPrice:60,stock:1200,lowStock:50,image:null},
    {name:'කුකුල් කිරිල්ලෝ 500g',category:'මස් හා මාළු',icon:'🍗',retailPrice:520,wholesalePrice:450,costPrice:395,stock:1000,lowStock:40,image:null},
    {name:'කුකුල් මස් 1kg',category:'මස් හා මාළු',icon:'🍗',retailPrice:820,wholesalePrice:705,costPrice:620,stock:800,lowStock:30,image:null},
    {name:'කුකුල් ඉලිප්ප 500g',category:'මස් හා මාළු',icon:'🍗',retailPrice:450,wholesalePrice:385,costPrice:338,stock:900,lowStock:35,image:null},
    {name:'හරක් මස් 500g',category:'මස් හා මාළු',icon:'🥩',retailPrice:750,wholesalePrice:645,costPrice:568,stock:600,lowStock:25,image:null},
    {name:'ඌරු මස් 500g',category:'මස් හා මාළු',icon:'🥩',retailPrice:680,wholesalePrice:580,costPrice:510,stock:500,lowStock:20,image:null},
    {name:'තිලාපියා 500g',category:'මස් හා මාළු',icon:'🐟',retailPrice:480,wholesalePrice:410,costPrice:360,stock:700,lowStock:30,image:null},
    {name:'ශ්‍රී මාළු 500g',category:'මස් හා මාළු',icon:'🐟',retailPrice:850,wholesalePrice:725,costPrice:638,stock:500,lowStock:20,image:null},
    {name:'ඉස්සෝ 500g',category:'මස් හා මාළු',icon:'🦐',retailPrice:980,wholesalePrice:840,costPrice:740,stock:400,lowStock:15,image:null},
    {name:'සාඩීන් 400g (tin)',category:'මස් හා මාළු',icon:'🐟',retailPrice:220,wholesalePrice:185,costPrice:162,stock:2000,lowStock:80,image:null},
    {name:'ටූනා 185g (tin)',category:'මස් හා මාළු',icon:'🐟',retailPrice:280,wholesalePrice:238,costPrice:208,stock:2000,lowStock:80,image:null},
    {name:'Mackerel 400g (tin)',category:'මස් හා මාළු',icon:'🐟',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1800,lowStock:80,image:null},
    {name:'බිත්තර (ට්‍රේ 12)',category:'මස් හා මාළු',icon:'🥚',retailPrice:395,wholesalePrice:338,costPrice:295,stock:1500,lowStock:60,image:null},
    {name:'බිත්තර (පෙට්ටිය 6)',category:'මස් හා මාළු',icon:'🥚',retailPrice:210,wholesalePrice:178,costPrice:155,stock:2000,lowStock:80,image:null},
    {name:'කුකුල් ලිවර් 500g',category:'මස් හා මාළු',icon:'🍗',retailPrice:320,wholesalePrice:272,costPrice:238,stock:600,lowStock:25,image:null},
    {name:'ශිතල සොසේජස් 500g',category:'මස් හා මාළු',icon:'🌭',retailPrice:420,wholesalePrice:358,costPrice:315,stock:800,lowStock:35,image:null},
    {name:'ශිතල කරාබු නැටි 400g',category:'මස් හා මාළු',icon:'🦑',retailPrice:580,wholesalePrice:495,costPrice:435,stock:400,lowStock:15,image:null},
    {name:'ශිතල ගෙළ 500g',category:'මස් හා මාළු',icon:'🦪',retailPrice:720,wholesalePrice:612,costPrice:540,stock:300,lowStock:15,image:null},
    {name:'ශිතල ශ්‍රිම්ප් 500g',category:'මස් හා මාළු',icon:'🦐',retailPrice:1250,wholesalePrice:1070,costPrice:940,stock:300,lowStock:15,image:null},
    {name:'Crab 500g',category:'මස් හා මාළු',icon:'🦀',retailPrice:1450,wholesalePrice:1240,costPrice:1090,stock:200,lowStock:10,image:null},
    {name:'Lobster 500g',category:'මස් හා මාළු',icon:'🦞',retailPrice:2800,wholesalePrice:2392,costPrice:2100,stock:100,lowStock:5,image:null},
    {name:'ශිතල කැළං 500g',category:'මස් හා මාළු',icon:'🐠',retailPrice:650,wholesalePrice:555,costPrice:488,stock:400,lowStock:15,image:null},
    {name:'ශිතල බේකන් 200g',category:'මස් හා මාළු',icon:'🥓',retailPrice:580,wholesalePrice:495,costPrice:435,stock:600,lowStock:25,image:null},
    {name:'ශිතල Ham 200g',category:'මස් හා මාළු',icon:'🥩',retailPrice:520,wholesalePrice:442,costPrice:388,stock:600,lowStock:25,image:null},
    {name:'Spam 340g (tin)',category:'මස් හා මාළු',icon:'🥩',retailPrice:480,wholesalePrice:408,costPrice:358,stock:800,lowStock:35,image:null},
    {name:'Corned Beef 340g (tin)',category:'මස් හා මාළු',icon:'🥩',retailPrice:450,wholesalePrice:382,costPrice:335,stock:1000,lowStock:40,image:null},
    {name:'ශිතල කිරාල 500g',category:'මස් හා මාළු',icon:'🐟',retailPrice:420,wholesalePrice:358,costPrice:315,stock:500,lowStock:20,image:null},
    {name:'ශිතල ඇස් 500g',category:'මස් හා මාළු',icon:'🐟',retailPrice:380,wholesalePrice:322,costPrice:282,stock:500,lowStock:20,image:null},
    {name:'ශිතල හලාවා 500g',category:'මස් හා මාළු',icon:'🐟',retailPrice:850,wholesalePrice:725,costPrice:638,stock:400,lowStock:15,image:null},
    {name:'Duck 500g',category:'මස් හා මාළු',icon:'🦆',retailPrice:920,wholesalePrice:785,costPrice:690,stock:400,lowStock:15,image:null},
    {name:'Turkey 1kg',category:'මස් හා මාළු',icon:'🦃',retailPrice:1480,wholesalePrice:1264,costPrice:1112,stock:200,lowStock:10,image:null},
    {name:'සුදු පාන් (ලොෆ්)',category:'බේකරි',icon:'🍞',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'දුඹුරු පාන්',category:'බේකරි',icon:'🍞',retailPrice:120,wholesalePrice:100,costPrice:85,stock:1500,lowStock:60,image:null},
    {name:'බන් (පැකට් 6)',category:'බේකරි',icon:'🍞',retailPrice:145,wholesalePrice:120,costPrice:100,stock:1500,lowStock:60,image:null},
    {name:'Croissant',category:'බේකරි',icon:'🥐',retailPrice:85,wholesalePrice:68,costPrice:56,stock:1000,lowStock:40,image:null},
    {name:'උපන්දින කේක් 500g',category:'බේකරි',icon:'🎂',retailPrice:850,wholesalePrice:720,costPrice:630,stock:300,lowStock:10,image:null},
    {name:'Swiss Roll',category:'බේකරි',icon:'🎂',retailPrice:195,wholesalePrice:165,costPrice:142,stock:800,lowStock:30,image:null},
    {name:'Butter Cake Slice',category:'බේකරි',icon:'🍰',retailPrice:95,wholesalePrice:78,costPrice:65,stock:800,lowStock:30,image:null},
    {name:'Chocolate Muffin',category:'බේකරි',icon:'🧁',retailPrice:110,wholesalePrice:90,costPrice:75,stock:800,lowStock:30,image:null},
    {name:'Pizza Roll',category:'බේකරි',icon:'🍕',retailPrice:120,wholesalePrice:98,costPrice:82,stock:700,lowStock:25,image:null},
    {name:'කොත්ත රොටී',category:'බේකරි',icon:'🫓',retailPrice:85,wholesalePrice:68,costPrice:56,stock:1200,lowStock:50,image:null},
    {name:'Doughnut (each)',category:'බේකරි',icon:'🍩',retailPrice:110,wholesalePrice:90,costPrice:75,stock:1000,lowStock:40,image:null},
    {name:'Bagel (each)',category:'බේකරි',icon:'🥯',retailPrice:145,wholesalePrice:120,costPrice:100,stock:600,lowStock:25,image:null},
    {name:'Cinnamon Roll (each)',category:'බේකරි',icon:'🥐',retailPrice:165,wholesalePrice:140,costPrice:120,stock:600,lowStock:25,image:null},
    {name:'Brownie (each)',category:'බේකරි',icon:'🍫',retailPrice:145,wholesalePrice:120,costPrice:100,stock:800,lowStock:35,image:null},
    {name:'Cheese Cake Slice',category:'බේකරි',icon:'🍰',retailPrice:280,wholesalePrice:238,costPrice:208,stock:400,lowStock:15,image:null},
    {name:'Fruit Tart (each)',category:'බේකරි',icon:'🥧',retailPrice:220,wholesalePrice:188,costPrice:165,stock:500,lowStock:20,image:null},
    {name:'Éclair (each)',category:'බේකරි',icon:'🍫',retailPrice:165,wholesalePrice:140,costPrice:120,stock:600,lowStock:25,image:null},
    {name:'Macaron (box 6)',category:'බේකරි',icon:'🍬',retailPrice:480,wholesalePrice:408,costPrice:358,stock:300,lowStock:15,image:null},
    {name:'Panettone 500g',category:'බේකරි',icon:'🍞',retailPrice:580,wholesalePrice:495,costPrice:435,stock:200,lowStock:10,image:null},
    {name:'Pumpernickel 300g',category:'බේකරි',icon:'🍞',retailPrice:320,wholesalePrice:272,costPrice:238,stock:400,lowStock:15,image:null},
    {name:'Rye Bread 400g',category:'බේකරි',icon:'🍞',retailPrice:280,wholesalePrice:238,costPrice:208,stock:500,lowStock:20,image:null},
    {name:'Sourdough Loaf',category:'බේකරි',icon:'🍞',retailPrice:380,wholesalePrice:322,costPrice:282,stock:400,lowStock:15,image:null},
    {name:'Banana Bread Loaf',category:'බේකරි',icon:'🍌',retailPrice:320,wholesalePrice:272,costPrice:238,stock:500,lowStock:20,image:null},
    {name:'Garlic Bread (pack)',category:'බේකරි',icon:'🧄',retailPrice:195,wholesalePrice:165,costPrice:142,stock:800,lowStock:35,image:null},
    {name:'Pita Bread (4pk)',category:'බේකරි',icon:'🫓',retailPrice:165,wholesalePrice:140,costPrice:120,stock:800,lowStock:35,image:null},
    {name:'Naan (4pk)',category:'බේකරි',icon:'🫓',retailPrice:155,wholesalePrice:130,costPrice:112,stock:800,lowStock:35,image:null},
    {name:'Tortilla Wraps (8pk)',category:'බේකරි',icon:'🫓',retailPrice:180,wholesalePrice:152,costPrice:132,stock:800,lowStock:35,image:null},
    {name:'Egg Tart (each)',category:'බේකරි',icon:'🥚',retailPrice:95,wholesalePrice:78,costPrice:65,stock:1000,lowStock:40,image:null},
    {name:'Sausage Roll (each)',category:'බේකරි',icon:'🌭',retailPrice:110,wholesalePrice:90,costPrice:75,stock:1000,lowStock:40,image:null},
    {name:'Coconut Bun (each)',category:'බේකරි',icon:'🍞',retailPrice:75,wholesalePrice:62,costPrice:52,stock:1500,lowStock:60,image:null},
    {name:'Surf Excel 1kg',category:'ගෘහ භාණ්ඩ',icon:'🧺',retailPrice:380,wholesalePrice:322,costPrice:282,stock:2000,lowStock:80,image:null},
    {name:'Ariel 1kg',category:'ගෘහ භාණ්ඩ',icon:'🧺',retailPrice:420,wholesalePrice:358,costPrice:315,stock:1800,lowStock:80,image:null},
    {name:'Sunlight Bar 125g',category:'ගෘහ භාණ්ඩ',icon:'🧼',retailPrice:55,wholesalePrice:42,costPrice:35,stock:5000,lowStock:200,image:null},
    {name:'Dettol Soap 100g',category:'ගෘහ භාණ්ඩ',icon:'🧼',retailPrice:120,wholesalePrice:98,costPrice:82,stock:3000,lowStock:150,image:null},
    {name:'Dettol Liquid 200ml',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1500,lowStock:60,image:null},
    {name:'Vim Dishwash 800ml',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:220,wholesalePrice:188,costPrice:165,stock:2000,lowStock:80,image:null},
    {name:'Comfort Fabric Softener 1L',category:'ගෘහ භාණ්ඩ',icon:'🧺',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1500,lowStock:60,image:null},
    {name:'Harpic Toilet Cleaner 500ml',category:'ගෘහ භාණ්ඩ',icon:'🚽',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'Baygon Spray 600ml',category:'ගෘහ භාණ්ඩ',icon:'🪲',retailPrice:580,wholesalePrice:495,costPrice:435,stock:1000,lowStock:40,image:null},
    {name:'Mortein Coil 10pk',category:'ගෘහ භාණ්ඩ',icon:'🪲',retailPrice:165,wholesalePrice:140,costPrice:120,stock:2000,lowStock:80,image:null},
    {name:'Scotch Brite Sponge',category:'ගෘහ භාණ්ඩ',icon:'🧽',retailPrice:95,wholesalePrice:78,costPrice:65,stock:3000,lowStock:150,image:null},
    {name:'Garbage Bags 30pk',category:'ගෘහ භාණ්ඩ',icon:'🗑',retailPrice:145,wholesalePrice:120,costPrice:100,stock:2000,lowStock:80,image:null},
    {name:'Glad Wrap 30m',category:'ගෘහ භාණ්ඩ',icon:'📦',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Aluminium Foil 30m',category:'ගෘහ භාණ්ඩ',icon:'📦',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1500,lowStock:60,image:null},
    {name:'Candles (box 12)',category:'ගෘහ භාණ්ඩ',icon:'🕯',retailPrice:145,wholesalePrice:120,costPrice:100,stock:2000,lowStock:80,image:null},
    {name:'Matches (box)',category:'ගෘහ භාණ්ඩ',icon:'🔥',retailPrice:45,wholesalePrice:35,costPrice:28,stock:5000,lowStock:200,image:null},
    {name:'AA Batteries 4pk',category:'ගෘහ භාණ්ඩ',icon:'🔋',retailPrice:280,wholesalePrice:238,costPrice:208,stock:2000,lowStock:80,image:null},
    {name:'AAA Batteries 4pk',category:'ගෘහ භාණ්ඩ',icon:'🔋',retailPrice:265,wholesalePrice:225,costPrice:198,stock:2000,lowStock:80,image:null},
    {name:'Extension Cord 5m',category:'ගෘහ භාණ්ඩ',icon:'🔌',retailPrice:680,wholesalePrice:580,costPrice:510,stock:500,lowStock:20,image:null},
    {name:'Light Bulb LED 10W',category:'ගෘහ භාණ්ඩ',icon:'💡',retailPrice:280,wholesalePrice:238,costPrice:208,stock:2000,lowStock:80,image:null},
    {name:'Toilet Paper 12 Rolls',category:'ගෘහ භාණ්ඩ',icon:'🧻',retailPrice:520,wholesalePrice:442,costPrice:388,stock:1500,lowStock:60,image:null},
    {name:'Tissue Box 150pk',category:'ගෘහ භාණ්ඩ',icon:'🧻',retailPrice:180,wholesalePrice:152,costPrice:132,stock:2500,lowStock:100,image:null},
    {name:'Kitchen Roll 2pk',category:'ගෘහ භාණ්ඩ',icon:'🧻',retailPrice:155,wholesalePrice:130,costPrice:112,stock:2000,lowStock:80,image:null},
    {name:'Dish Soap 500ml',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2500,lowStock:100,image:null},
    {name:'Floor Cleaner 1L',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1500,lowStock:60,image:null},
    {name:'Glass Cleaner 500ml',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Air Freshener 300ml',category:'ගෘහ භාණ්ඩ',icon:'🌸',retailPrice:320,wholesalePrice:272,costPrice:238,stock:1200,lowStock:50,image:null},
    {name:'Mold Remover 500ml',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1000,lowStock:40,image:null},
    {name:'Drain Cleaner 500ml',category:'ගෘහ භාණ්ඩ',icon:'🚰',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Dishwasher Tabs 20pk',category:'ගෘහ භාණ්ඩ',icon:'🧺',retailPrice:580,wholesalePrice:495,costPrice:435,stock:800,lowStock:30,image:null},
    {name:'Dove Shampoo 200ml',category:'පෞද්ගලික සෙනෙහස',icon:'💆',retailPrice:280,wholesalePrice:238,costPrice:208,stock:2000,lowStock:80,image:null},
    {name:'Head & Shoulders 200ml',category:'පෞද්ගලික සෙනෙහස',icon:'💆',retailPrice:320,wholesalePrice:272,costPrice:238,stock:1800,lowStock:80,image:null},
    {name:'Pantene 200ml',category:'පෞද්ගලික සෙනෙහස',icon:'💆',retailPrice:295,wholesalePrice:250,costPrice:218,stock:1800,lowStock:80,image:null},
    {name:'Colgate Toothpaste 150g',category:'පෞද්ගලික සෙනෙහස',icon:'🦷',retailPrice:195,wholesalePrice:165,costPrice:142,stock:3000,lowStock:150,image:null},
    {name:'Oral-B Toothpaste 150g',category:'පෞද්ගලික සෙනෙහස',icon:'🦷',retailPrice:220,wholesalePrice:188,costPrice:165,stock:2500,lowStock:100,image:null},
    {name:'Dettol Body Wash 250ml',category:'පෞද්ගලික සෙනෙහස',icon:'🚿',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'Nivea Body Lotion 250ml',category:'පෞද්ගලික සෙනෙහස',icon:'💧',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1200,lowStock:50,image:null},
    {name:'Vaseline 250ml',category:'පෞද්ගලික සෙනෙහස',icon:'💧',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1500,lowStock:60,image:null},
    {name:'Sunscreen SPF50 100ml',category:'පෞද්ගලික සෙනෙහස',icon:'☀️',retailPrice:480,wholesalePrice:408,costPrice:358,stock:1000,lowStock:40,image:null},
    {name:'Deodorant Spray 150ml',category:'පෞද්ගලික සෙනෙහස',icon:'💨',retailPrice:280,wholesalePrice:238,costPrice:208,stock:2000,lowStock:80,image:null},
    {name:'Gillette Razor 2pk',category:'පෞද්ගලික සෙනෙහස',icon:'🪒',retailPrice:195,wholesalePrice:165,costPrice:142,stock:2000,lowStock:80,image:null},
    {name:'Shaving Foam 200ml',category:'පෞද්ගලික සෙනෙහස',icon:'🪒',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Cotton Buds 200pk',category:'පෞද්ගලික සෙනෙහස',icon:'👂',retailPrice:95,wholesalePrice:78,costPrice:65,stock:3000,lowStock:150,image:null},
    {name:'Sanitary Pads 10pk',category:'පෞද්ගලික සෙනෙහස',icon:'🩹',retailPrice:280,wholesalePrice:238,costPrice:208,stock:2000,lowStock:80,image:null},
    {name:'Baby Powder 100g',category:'පෞද්ගලික සෙනෙහස',icon:'👶',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Baby Shampoo 200ml',category:'පෞද්ගලික සෙනෙහස',icon:'👶',retailPrice:320,wholesalePrice:272,costPrice:238,stock:1200,lowStock:50,image:null},
    {name:'Wet Wipes 80pk',category:'පෞද්ගලික සෙනෙහස',icon:'🧴',retailPrice:195,wholesalePrice:165,costPrice:142,stock:2000,lowStock:80,image:null},
    {name:'Nail Polish Remover 100ml',category:'පෞද්ගලික සෙනෙහස',icon:'💅',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Hair Oil 100ml',category:'පෞද්ගලික සෙනෙහස',icon:'💆',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Fair & Lovely Cream 50g',category:'පෞද්ගලික සෙනෙහස',icon:'💆',retailPrice:195,wholesalePrice:165,costPrice:142,stock:2000,lowStock:80,image:null},
    {name:'Johnson Baby Oil 200ml',category:'පෞද්ගලික සෙනෙහස',icon:'👶',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'Pampers Diapers S 30pk',category:'පෞද්ගලික සෙනෙහස',icon:'👶',retailPrice:1480,wholesalePrice:1264,costPrice:1112,stock:800,lowStock:30,image:null},
    {name:'Pampers Diapers M 28pk',category:'පෞද්ගලික සෙනෙහස',icon:'👶',retailPrice:1550,wholesalePrice:1325,costPrice:1165,stock:800,lowStock:30,image:null},
    {name:'Pampers Diapers L 26pk',category:'පෞද්ගලික සෙනෙහස',icon:'👶',retailPrice:1620,wholesalePrice:1385,costPrice:1218,stock:600,lowStock:25,image:null},
    {name:'Listerine Mouthwash 250ml',category:'පෞද්ගලික සෙනෙහස',icon:'🦷',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1200,lowStock:50,image:null},
    {name:'Floss 50m',category:'පෞද්ගලික සෙනෙහස',icon:'🦷',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Cotton Balls 100pk',category:'පෞද්ගලික සෙනෙහස',icon:'☁️',retailPrice:95,wholesalePrice:78,costPrice:65,stock:3000,lowStock:150,image:null},
    {name:'Face Wash 100ml',category:'පෞද්ගලික සෙනෙහස',icon:'💆',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'Moisturizer 100ml',category:'පෞද්ගලික සෙනෙහස',icon:'💧',retailPrice:420,wholesalePrice:358,costPrice:315,stock:1000,lowStock:40,image:null},
    {name:'Lip Balm',category:'පෞද්ගලික සෙනෙහස',icon:'👄',retailPrice:120,wholesalePrice:98,costPrice:82,stock:2000,lowStock:80,image:null},
    {name:'පොල් තෙල් 1L',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:420,wholesalePrice:358,costPrice:315,stock:2000,lowStock:80,image:null},
    {name:'සූරිය ගිනිතෙල් 1L',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:380,wholesalePrice:322,costPrice:282,stock:2000,lowStock:80,image:null},
    {name:'Olive Oil Extra Virgin 500ml',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:850,wholesalePrice:725,costPrice:638,stock:800,lowStock:30,image:null},
    {name:'Canola Oil 1L',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:350,wholesalePrice:298,costPrice:262,stock:1500,lowStock:60,image:null},
    {name:'සුදු සීනි 1kg',category:'ඉවුම් පිහුම්',icon:'🍚',retailPrice:120,wholesalePrice:98,costPrice:82,stock:3000,lowStock:150,image:null},
    {name:'දොඹ සීනි 1kg',category:'ඉවුම් පිහුම්',icon:'🍚',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2500,lowStock:100,image:null},
    {name:'සාදු ලිව 200g',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:195,wholesalePrice:165,costPrice:142,stock:2500,lowStock:100,image:null},
    {name:'Maldive Fish 100g',category:'ඉවුම් පිහුම්',icon:'🐟',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1500,lowStock:60,image:null},
    {name:'ගම්මිරිස් 100g',category:'ඉවුම් පිහුම්',icon:'🌶',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'ලෙමන් ග්‍රාස් 50g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:95,wholesalePrice:78,costPrice:65,stock:1500,lowStock:60,image:null},
    {name:'කරුවල් 200g',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1500,lowStock:60,image:null},
    {name:'ඉදිකටු 100g',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Apple Cider Vinegar 500ml',category:'ඉවුම් පිහුම්',icon:'🍶',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1000,lowStock:40,image:null},
    {name:'Soy Sauce 200ml',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1500,lowStock:60,image:null},
    {name:'Worcestershire Sauce 150ml',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Tomato Sauce 400g',category:'ඉවුම් පිහුම්',icon:'🍅',retailPrice:165,wholesalePrice:140,costPrice:120,stock:2000,lowStock:80,image:null},
    {name:'Chilli Sauce 340g',category:'ඉවුම් පිහුම්',icon:'🌶',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Mayonnaise 400g',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'Mustard 250g',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Ketchup 570g',category:'ඉවුම් පිහුම්',icon:'🍅',retailPrice:280,wholesalePrice:238,costPrice:208,stock:2000,lowStock:80,image:null},
    {name:'Mixed Spice 100g',category:'ඉවුම් පිහුම්',icon:'🌶',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'Curry Powder 200g',category:'ඉවුම් පිහුම්',icon:'🌶',retailPrice:195,wholesalePrice:165,costPrice:142,stock:2000,lowStock:80,image:null},
    {name:'Turmeric Powder 100g',category:'ඉවුම් පිහුම්',icon:'🟡',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Coriander Powder 100g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Cumin Powder 100g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1800,lowStock:80,image:null},
    {name:'Chilli Powder 100g',category:'ඉවුම් පිහුම්',icon:'🌶',retailPrice:165,wholesalePrice:140,costPrice:120,stock:2000,lowStock:80,image:null},
    {name:'Cloves 50g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Cardamom 50g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:30,image:null},
    {name:'Cinnamon Sticks 50g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Bay Leaves 25g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:120,wholesalePrice:100,costPrice:85,stock:2000,lowStock:80,image:null},
    {name:'Baking Powder 100g',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Baking Soda 200g',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:75,wholesalePrice:62,costPrice:52,stock:2000,lowStock:80,image:null},
    {name:'Vanilla Extract 30ml',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Cocoa Powder 200g',category:'ඉවුම් පිහුම්',icon:'🍫',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1200,lowStock:50,image:null},
    {name:'Bread Crumbs 200g',category:'ඉවුම් පිහුම්',icon:'🍞',retailPrice:120,wholesalePrice:100,costPrice:85,stock:1500,lowStock:60,image:null},
    {name:'Corn Flour 250g',category:'ඉවුම් පිහුම්',icon:'🌽',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Yeast 7g',category:'ඉවුම් පිහුම්',icon:'🍞',retailPrice:45,wholesalePrice:35,costPrice:28,stock:3000,lowStock:150,image:null},
    {name:'Gelatin 10g',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:95,wholesalePrice:78,costPrice:65,stock:1500,lowStock:60,image:null},
    {name:'Food Colouring Set',category:'ඉවුම් පිහුම්',icon:'🎨',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Pandan Leaves (fresh)',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:45,wholesalePrice:35,costPrice:28,stock:2000,lowStock:80,image:null},
    {name:'Lemon Grass (fresh)',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:55,wholesalePrice:45,costPrice:38,stock:1500,lowStock:60,image:null},
    {name:'Curry Leaves (fresh)',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:30,wholesalePrice:24,costPrice:18,stock:3000,lowStock:150,image:null},
    {name:'Ice Cream 500ml',category:'ශිතල හා Frozen',icon:'🍦',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:30,image:null},
    {name:'ශිතල ෆ්‍රෙන්ච් ෆ්‍රයිස් 500g',category:'ශිතල හා Frozen',icon:'🍟',retailPrice:320,wholesalePrice:272,costPrice:238,stock:600,lowStock:25,image:null},
    {name:'ශිතල Burger Patties 4pk',category:'ශිතල හා Frozen',icon:'🍔',retailPrice:480,wholesalePrice:408,costPrice:358,stock:500,lowStock:20,image:null},
    {name:'ශිතල Pizza 300g',category:'ශිතල හා Frozen',icon:'🍕',retailPrice:520,wholesalePrice:442,costPrice:388,stock:400,lowStock:15,image:null},
    {name:'ශිතල Sausages 500g',category:'ශිතල හා Frozen',icon:'🌭',retailPrice:420,wholesalePrice:358,costPrice:315,stock:600,lowStock:25,image:null},
    {name:'ශිතල Spring Rolls 400g',category:'ශිතල හා Frozen',icon:'🥟',retailPrice:380,wholesalePrice:322,costPrice:282,stock:500,lowStock:20,image:null},
    {name:'ශිතල Dim Sum 12pk',category:'ශිතල හා Frozen',icon:'🥟',retailPrice:520,wholesalePrice:442,costPrice:388,stock:400,lowStock:15,image:null},
    {name:'Ice Cream Cone (each)',category:'ශිතල හා Frozen',icon:'🍦',retailPrice:95,wholesalePrice:78,costPrice:65,stock:1000,lowStock:40,image:null},
    {name:'Frozen Yogurt 500ml',category:'ශිතල හා Frozen',icon:'🍦',retailPrice:320,wholesalePrice:272,costPrice:238,stock:600,lowStock:25,image:null},
    {name:'Gelato 500ml',category:'ශිතල හා Frozen',icon:'🍨',retailPrice:520,wholesalePrice:442,costPrice:388,stock:400,lowStock:15,image:null},
    {name:'ශිතල Nuggets 500g',category:'ශිතල හා Frozen',icon:'🍗',retailPrice:480,wholesalePrice:408,costPrice:358,stock:600,lowStock:25,image:null},
    {name:'ශිතල Fish Fingers 400g',category:'ශිතල හා Frozen',icon:'🐟',retailPrice:380,wholesalePrice:322,costPrice:282,stock:500,lowStock:20,image:null},
    {name:'ශිතල Corn 400g',category:'ශිතල හා Frozen',icon:'🌽',retailPrice:195,wholesalePrice:165,costPrice:142,stock:800,lowStock:35,image:null},
    {name:'ශිතල Peas 400g',category:'ශිතල හා Frozen',icon:'🫘',retailPrice:180,wholesalePrice:152,costPrice:132,stock:800,lowStock:35,image:null},
    {name:'ශිතල Mixed Veg 400g',category:'ශිතල හා Frozen',icon:'🥦',retailPrice:195,wholesalePrice:165,costPrice:142,stock:800,lowStock:35,image:null},
    {name:'ශිතල Edamame 300g',category:'ශිතල හා Frozen',icon:'🫘',retailPrice:280,wholesalePrice:238,costPrice:208,stock:500,lowStock:20,image:null},
    {name:'Popsicle 6pk',category:'ශිතල හා Frozen',icon:'🍭',retailPrice:220,wholesalePrice:188,costPrice:165,stock:800,lowStock:35,image:null},
    {name:'Sorbet 500ml',category:'ශිතල හා Frozen',icon:'🍧',retailPrice:380,wholesalePrice:322,costPrice:282,stock:500,lowStock:20,image:null},
    {name:'ශිතල Parata 5pk',category:'ශිතල හා Frozen',icon:'🫓',retailPrice:280,wholesalePrice:238,costPrice:208,stock:600,lowStock:25,image:null},
    {name:'ශිතල Naan 4pk',category:'ශිතල හා Frozen',icon:'🫓',retailPrice:220,wholesalePrice:188,costPrice:165,stock:800,lowStock:35,image:null},
    {name:'ශිතල Samosa 8pk',category:'ශිතල හා Frozen',icon:'🥟',retailPrice:280,wholesalePrice:238,costPrice:208,stock:600,lowStock:25,image:null},
    {name:'Ice 2kg',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:120,wholesalePrice:100,costPrice:85,stock:2000,lowStock:80,image:null},
    {name:'ජාතික ගම්මිරිස් 100g',category:'ශ්‍රී ලාංකීය',icon:'🌶',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1000,lowStock:40,image:null},
    {name:'Goraka 100g',category:'ශ්‍රී ලාංකීය',icon:'🟡',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1500,lowStock:60,image:null},
    {name:'Rampe 50g',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:55,wholesalePrice:45,costPrice:38,stock:2000,lowStock:80,image:null},
    {name:'Kasa Kasa 100g',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1200,lowStock:50,image:null},
    {name:'Kiri Hodi Mix 100g',category:'ශ්‍රී ලාංකීය',icon:'🫙',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Pol Sambol Mix 100g',category:'ශ්‍රී ලාංකීය',icon:'🥥',retailPrice:120,wholesalePrice:100,costPrice:85,stock:1500,lowStock:60,image:null},
    {name:'Seeni Sambol 200g',category:'ශ්‍රී ලාංකීය',icon:'🧅',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1200,lowStock:50,image:null},
    {name:'Lunu Miris Paste 100g',category:'ශ්‍රී ලාංකීය',icon:'🌶',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'String Hopper Press',category:'ශ්‍රී ලාංකීය',icon:'🍜',retailPrice:280,wholesalePrice:238,costPrice:208,stock:500,lowStock:20,image:null},
    {name:'Appam Pan',category:'ශ්‍රී ලාංකීය',icon:'🍳',retailPrice:480,wholesalePrice:408,costPrice:358,stock:300,lowStock:15,image:null},
    {name:'Hoppers Mix 500g',category:'ශ්‍රී ලාංකීය',icon:'🫙',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Kottu Mix 300g',category:'ශ්‍රී ලාංකීය',icon:'🫙',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1500,lowStock:60,image:null},
    {name:'Pol Roti Mix 500g',category:'ශ්‍රී ලාංකීය',icon:'🫙',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Kithul Treacle 300ml',category:'ශ්‍රී ලාංකීය',icon:'🍯',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:30,image:null},
    {name:'Kithul Jaggery 500g',category:'ශ්‍රී ලාංකීය',icon:'🍯',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Coconut Treacle 300ml',category:'ශ්‍රී ලාංකීය',icon:'🥥',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Pol Pani 500ml',category:'ශ්‍රී ලාංකීය',icon:'🥥',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1200,lowStock:50,image:null},
    {name:'Ambulthiyal Paste 200g',category:'ශ්‍රී ලාංකීය',icon:'🫙',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1200,lowStock:50,image:null},
    {name:'Gongura Paste 200g',category:'ශ්‍රී ලාංකීය',icon:'🫙',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1200,lowStock:50,image:null},
    {name:'Sri Lankan Pickle 300g',category:'ශ්‍රී ලාංකීය',icon:'🫙',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1000,lowStock:40,image:null},
    {name:'Coconut Milk 400ml (tin)',category:'ශ්‍රී ලාංකීය',icon:'🥥',retailPrice:195,wholesalePrice:165,costPrice:142,stock:2000,lowStock:80,image:null},
    {name:'Coconut Cream 200ml',category:'ශ්‍රී ලාංකීය',icon:'🥥',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Coconut Water 330ml (tin)',category:'ශ්‍රී ලාංකීය',icon:'🥥',retailPrice:120,wholesalePrice:98,costPrice:82,stock:2000,lowStock:80,image:null},
    {name:'Dried Coconut 200g',category:'ශ්‍රී ලාංකීය',icon:'🥥',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Desiccated Coconut 200g',category:'ශ්‍රී ලාංකීය',icon:'🥥',retailPrice:120,wholesalePrice:100,costPrice:85,stock:2000,lowStock:80,image:null},
    {name:'Jak Fruit Curry 400g (tin)',category:'ශ්‍රී ලාංකීය',icon:'🍈',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Mango Chutney 300g',category:'ශ්‍රී ලාංකීය',icon:'🥭',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1000,lowStock:40,image:null},
    {name:'Tamarind Paste 200g',category:'ශ්‍රී ලාංකීය',icon:'🫙',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1500,lowStock:60,image:null},
    {name:'Dried Maldive Fish 50g',category:'ශ්‍රී ලාංකීය',icon:'🐟',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Sri Lanka Jaffna Curry 100g',category:'ශ්‍රී ලාංකීය',icon:'🌶',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:30,image:null},
    {name:'Cerelac 400g (Stage 1)',category:'ළමා ආහාර',icon:'👶',retailPrice:780,wholesalePrice:665,costPrice:585,stock:800,lowStock:30,image:null},
    {name:'Cerelac 400g (Stage 2)',category:'ළමා ආහාර',icon:'👶',retailPrice:820,wholesalePrice:700,costPrice:615,stock:800,lowStock:30,image:null},
    {name:'Cerelac 400g (Stage 3)',category:'ළමා ආහාර',icon:'👶',retailPrice:850,wholesalePrice:725,costPrice:638,stock:800,lowStock:30,image:null},
    {name:'Nestum 250g',category:'ළමා ආහාර',icon:'👶',retailPrice:480,wholesalePrice:408,costPrice:358,stock:1000,lowStock:40,image:null},
    {name:'Farex 500g',category:'ළමා ආහාර',icon:'👶',retailPrice:620,wholesalePrice:528,costPrice:465,stock:800,lowStock:30,image:null},
    {name:'Baby Rice 200g',category:'ළමා ආහාර',icon:'👶',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1000,lowStock:40,image:null},
    {name:'Baby Puree (pouches)',category:'ළමා ආහාර',icon:'👶',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1500,lowStock:60,image:null},
    {name:'Baby Formula S-1 400g',category:'ළමා ආහාර',icon:'👶',retailPrice:2800,wholesalePrice:2392,costPrice:2100,stock:500,lowStock:20,image:null},
    {name:'Baby Formula S-2 400g',category:'ළමා ආහාර',icon:'👶',retailPrice:2600,wholesalePrice:2220,costPrice:1950,stock:500,lowStock:20,image:null},
    {name:'Baby Formula S-3 400g',category:'ළමා ආහාර',icon:'👶',retailPrice:2400,wholesalePrice:2048,costPrice:1800,stock:500,lowStock:20,image:null},
    {name:'Baby Yogurt 100g (4pk)',category:'ළමා ආහාර',icon:'👶',retailPrice:420,wholesalePrice:358,costPrice:315,stock:800,lowStock:30,image:null},
    {name:'Baby Snacks 50g',category:'ළමා ආහාර',icon:'👶',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Baby Water 500ml',category:'ළමා ආහාර',icon:'👶',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Baby Fruit Juice 125ml',category:'ළමා ආහාර',icon:'👶',retailPrice:120,wholesalePrice:100,costPrice:85,stock:1500,lowStock:60,image:null},
    {name:'Teething Biscuits 120g',category:'ළමා ආහාර',icon:'👶',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'A4 Paper 500pk',category:'ශිල්ප ද්‍රව්‍ය',icon:'📄',retailPrice:420,wholesalePrice:358,costPrice:315,stock:1000,lowStock:40,image:null},
    {name:'Ballpoint Pens 12pk',category:'ශිල්ප ද්‍රව්‍ය',icon:'🖊',retailPrice:195,wholesalePrice:165,costPrice:142,stock:2000,lowStock:80,image:null},
    {name:'Pencils 12pk',category:'ශිල්ප ද්‍රව්‍ය',icon:'✏️',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Notebook A5',category:'ශිල්ප ද්‍රව්‍ය',icon:'📓',retailPrice:165,wholesalePrice:140,costPrice:120,stock:2000,lowStock:80,image:null},
    {name:'Stapler',category:'ශිල්ප ද්‍රව්‍ය',icon:'📎',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Staples 1000pk',category:'ශිල්ප ද්‍රව්‍ය',icon:'📎',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Tape 48mm',category:'ශිල්ප ද්‍රව්‍ය',icon:'📦',retailPrice:95,wholesalePrice:78,costPrice:65,stock:3000,lowStock:150,image:null},
    {name:'Rubber Bands 100g',category:'ශිල්ප ද්‍රව්‍ය',icon:'🔗',retailPrice:65,wholesalePrice:52,costPrice:42,stock:3000,lowStock:150,image:null},
    {name:'Paper Clips 100pk',category:'ශිල්ප ද්‍රව්‍ය',icon:'📎',retailPrice:65,wholesalePrice:52,costPrice:42,stock:3000,lowStock:150,image:null},
    {name:'Highlighters 4pk',category:'ශිල්ප ද්‍රව්‍ය',icon:'🖊',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Scissors',category:'ශිල්ප ද්‍රව්‍ය',icon:'✂️',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Glue Stick',category:'ශිල්ප ද්‍රව්‍ය',icon:'🖊',retailPrice:75,wholesalePrice:62,costPrice:52,stock:3000,lowStock:150,image:null},
    {name:'Correction Fluid',category:'ශිල්ප ද්‍රව්‍ය',icon:'🖊',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Envelope A4 10pk',category:'ශිල්ප ද්‍රව්‍ය',icon:'✉️',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Panadol 10pk',category:'සෞඛ්‍ය',icon:'💊',retailPrice:180,wholesalePrice:150,costPrice:128,stock:2000,lowStock:80,image:null},
    {name:'Disprin 10pk',category:'සෞඛ්‍ය',icon:'💊',retailPrice:120,wholesalePrice:98,costPrice:82,stock:2000,lowStock:80,image:null},
    {name:'Antacid Tablets 20pk',category:'සෞඛ්‍ය',icon:'💊',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Vitamin C 20pk',category:'සෞඛ්‍ය',icon:'💊',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1500,lowStock:60,image:null},
    {name:'Vitamin D3 30pk',category:'සෞඛ්‍ය',icon:'💊',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1000,lowStock:40,image:null},
    {name:'Multivitamin 30pk',category:'සෞඛ්‍ය',icon:'💊',retailPrice:420,wholesalePrice:358,costPrice:315,stock:1000,lowStock:40,image:null},
    {name:'Fish Oil 60pk',category:'සෞඛ්‍ය',icon:'💊',retailPrice:520,wholesalePrice:442,costPrice:388,stock:800,lowStock:30,image:null},
    {name:'Calcium 30pk',category:'සෞඛ්‍ය',icon:'💊',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1000,lowStock:40,image:null},
    {name:'Iron Supplement 30pk',category:'සෞඛ්‍ය',icon:'💊',retailPrice:320,wholesalePrice:272,costPrice:238,stock:1000,lowStock:40,image:null},
    {name:'Band Aid 20pk',category:'සෞඛ්‍ය',icon:'🩹',retailPrice:195,wholesalePrice:165,costPrice:142,stock:2000,lowStock:80,image:null},
    {name:'Antiseptic Cream 50g',category:'සෞඛ්‍ය',icon:'🩹',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1500,lowStock:60,image:null},
    {name:'Thermometer',category:'සෞඛ්‍ය',icon:'🌡️',retailPrice:580,wholesalePrice:495,costPrice:435,stock:500,lowStock:20,image:null},
    {name:'Hand Sanitizer 100ml',category:'සෞඛ්‍ය',icon:'🧴',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Mask (3-ply) 10pk',category:'සෞඛ්‍ය',icon:'😷',retailPrice:120,wholesalePrice:98,costPrice:82,stock:3000,lowStock:150,image:null},
    {name:'Glucose Powder 400g',category:'සෞඛ්‍ය',icon:'💊',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'ORS Powder 10pk',category:'සෞඛ්‍ය',icon:'💊',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Cough Syrup 100ml',category:'සෞඛ්‍ය',icon:'💊',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Ear Drops 10ml',category:'සෞඛ්‍ය',icon:'💊',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Eye Drops 10ml',category:'සෞඛ්‍ය',icon:'💊',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Muscle Rub 50g',category:'සෞඛ්‍ය',icon:'💊',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1500,lowStock:60,image:null},
    {name:'USB Cable 1m',category:'ඉලෙක්ට්‍රොනික',icon:'🔌',retailPrice:195,wholesalePrice:165,costPrice:142,stock:2000,lowStock:80,image:null},
    {name:'Phone Charger 5W',category:'ඉලෙක්ට්‍රොනික',icon:'🔌',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1500,lowStock:60,image:null},
    {name:'Earphones',category:'ඉලෙක්ට්‍රොනික',icon:'🎧',retailPrice:480,wholesalePrice:408,costPrice:358,stock:1000,lowStock:40,image:null},
    {name:'Phone Stand',category:'ඉලෙක්ට්‍රොනික',icon:'📱',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1500,lowStock:60,image:null},
    {name:'Screen Protector',category:'ඉලෙක්ට්‍රොනික',icon:'📱',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Phone Case Universal',category:'ඉලෙක්ට්‍රොනික',icon:'📱',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Power Bank 10000mAh',category:'ඉලෙක්ට්‍රොනික',icon:'🔋',retailPrice:1480,wholesalePrice:1264,costPrice:1112,stock:500,lowStock:20,image:null},
    {name:'SD Card 32GB',category:'ඉලෙක්ට්‍රොනික',icon:'💾',retailPrice:520,wholesalePrice:442,costPrice:388,stock:1000,lowStock:40,image:null},
    {name:'USB Flash 32GB',category:'ඉලෙක්ට්‍රොනික',icon:'💾',retailPrice:480,wholesalePrice:408,costPrice:358,stock:1000,lowStock:40,image:null},
    {name:'Bluetooth Speaker',category:'ඉලෙක්ට්‍රොනික',icon:'🔊',retailPrice:1280,wholesalePrice:1090,costPrice:960,stock:300,lowStock:15,image:null},
    {name:'LED Strip 5m',category:'ඉලෙක්ට්‍රොනික',icon:'💡',retailPrice:580,wholesalePrice:495,costPrice:435,stock:500,lowStock:20,image:null},
    {name:'Smart Plug',category:'ඉලෙක්ට්‍රොනික',icon:'🔌',retailPrice:580,wholesalePrice:495,costPrice:435,stock:500,lowStock:20,image:null},
    {name:'HDMI Cable 1.5m',category:'ඉලෙක්ට්‍රොනික',icon:'📺',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1000,lowStock:40,image:null},
    {name:'Wireless Mouse',category:'ඉලෙක්ට්‍රොනික',icon:'🖱️',retailPrice:680,wholesalePrice:580,costPrice:510,stock:500,lowStock:20,image:null},
    {name:'Keyboard USB',category:'ඉලෙක්ට්‍රොනික',icon:'⌨️',retailPrice:780,wholesalePrice:665,costPrice:585,stock:500,lowStock:20,image:null},
    {name:'Playing Cards',category:'කෙළිලොල්',icon:'🃏',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Chess Set',category:'කෙළිලොල්',icon:'♟️',retailPrice:680,wholesalePrice:580,costPrice:510,stock:300,lowStock:15,image:null},
    {name:'Carrom Board (small)',category:'කෙළිලොල්',icon:'🎮',retailPrice:1280,wholesalePrice:1090,costPrice:960,stock:200,lowStock:10,image:null},
    {name:'Badminton Shuttles 6pk',category:'කෙළිලොල්',icon:'🏸',retailPrice:280,wholesalePrice:238,costPrice:208,stock:500,lowStock:20,image:null},
    {name:'Cricket Ball',category:'කෙළිලොල්',icon:'🏏',retailPrice:320,wholesalePrice:272,costPrice:238,stock:500,lowStock:20,image:null},
    {name:'Football',category:'කෙළිලොල්',icon:'⚽',retailPrice:1480,wholesalePrice:1264,costPrice:1112,stock:200,lowStock:10,image:null},
    {name:'Skipping Rope',category:'කෙළිලොල්',icon:'🪢',retailPrice:220,wholesalePrice:188,costPrice:165,stock:800,lowStock:35,image:null},
    {name:'Bubbles Set',category:'කෙළිලොල්',icon:'🫧',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Crayons 24pk',category:'කෙළිලොල්',icon:'🖍️',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Colour Pencils 12pk',category:'කෙළිලොල්',icon:'🖍️',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1000,lowStock:40,image:null},
    {name:'Playdough 4pk',category:'කෙළිලොල්',icon:'🎨',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:35,image:null},
    {name:'Puzzle 100pc',category:'කෙළිලොල්',icon:'🧩',retailPrice:380,wholesalePrice:322,costPrice:282,stock:500,lowStock:20,image:null},
    {name:'Lego (small set)',category:'කෙළිලොල්',icon:'🧱',retailPrice:680,wholesalePrice:580,costPrice:510,stock:300,lowStock:15,image:null},
    {name:'Toy Car',category:'කෙළිලොල්',icon:'🚗',retailPrice:380,wholesalePrice:322,costPrice:282,stock:500,lowStock:20,image:null},
    {name:'Stuffed Toy',category:'කෙළිලොල්',icon:'🧸',retailPrice:520,wholesalePrice:442,costPrice:388,stock:500,lowStock:20,image:null},
    {name:'Socks (3pk)',category:'ඇඳුම් හා ආශ්‍රිත',icon:'🧦',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Handkerchief (3pk)',category:'ඇඳුම් හා ආශ්‍රිත',icon:'🧣',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Belt (fabric)',category:'ඇඳුම් හා ආශ්‍රිත',icon:'👔',retailPrice:380,wholesalePrice:322,costPrice:282,stock:500,lowStock:20,image:null},
    {name:'Cap',category:'ඇඳුම් හා ආශ්‍රිත',icon:'🧢',retailPrice:480,wholesalePrice:408,costPrice:358,stock:500,lowStock:20,image:null},
    {name:'Umbrella (small)',category:'ඇඳුම් හා ආශ්‍රිත',icon:'☂️',retailPrice:480,wholesalePrice:408,costPrice:358,stock:500,lowStock:20,image:null},
    {name:'Slippers (pair)',category:'ඇඳුම් හා ආශ්‍රිත',icon:'👡',retailPrice:580,wholesalePrice:495,costPrice:435,stock:500,lowStock:20,image:null},
    {name:'Shoe Laces',category:'ඇඳුම් හා ආශ්‍රිත',icon:'👟',retailPrice:75,wholesalePrice:62,costPrice:52,stock:2000,lowStock:80,image:null},
    {name:'Shoe Polish Black',category:'ඇඳුම් හා ආශ්‍රිත',icon:'👟',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Clothes Hanger 10pk',category:'ඇඳුම් හා ආශ්‍රිත',icon:'🪝',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Laundry Basket',category:'ඇඳුම් හා ආශ්‍රිත',icon:'🧺',retailPrice:680,wholesalePrice:580,costPrice:510,stock:300,lowStock:15,image:null},
    {name:'Plastic Plate Set 6pk',category:'කෑම් බඳුන්',icon:'🍽️',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:35,image:null},
    {name:'Steel Plate Set 6pk',category:'කෑම් බඳුන්',icon:'🍽️',retailPrice:680,wholesalePrice:580,costPrice:510,stock:500,lowStock:20,image:null},
    {name:'Mug Set 4pk',category:'කෑම් බඳුන්',icon:'☕',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:35,image:null},
    {name:'Glass Set 6pk',category:'කෑම් බඳුන්',icon:'🥃',retailPrice:480,wholesalePrice:408,costPrice:358,stock:500,lowStock:20,image:null},
    {name:'Plastic Containers 3pk',category:'කෑම් බඳුන්',icon:'📦',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Lunchbox',category:'කෑම් බඳුන්',icon:'🍱',retailPrice:480,wholesalePrice:408,costPrice:358,stock:800,lowStock:35,image:null},
    {name:'Water Bottle 1L',category:'කෑම් බඳුන්',icon:'💧',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1000,lowStock:40,image:null},
    {name:'Thermos Flask 1L',category:'කෑම් බඳුන්',icon:'☕',retailPrice:880,wholesalePrice:750,costPrice:660,stock:500,lowStock:20,image:null},
    {name:'Non-stick Pan 24cm',category:'කෑම් බඳුන්',icon:'🍳',retailPrice:1280,wholesalePrice:1090,costPrice:960,stock:300,lowStock:15,image:null},
    {name:'Steel Pot 3L',category:'කෑම් බඳුන්',icon:'🫕',retailPrice:880,wholesalePrice:750,costPrice:660,stock:500,lowStock:20,image:null},
    {name:'Wooden Spoon Set',category:'කෑම් බඳුන්',icon:'🥄',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Peeler',category:'කෑම් බඳුන්',icon:'🍎',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Can Opener',category:'කෑම් බඳුන්',icon:'🥫',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Cutting Board',category:'කෑම් බඳුන්',icon:'🔪',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:35,image:null},
    {name:'Kitchen Knife Set',category:'කෑම් බඳුන්',icon:'🔪',retailPrice:1280,wholesalePrice:1090,costPrice:960,stock:300,lowStock:15,image:null},
    {name:'Grater',category:'කෑම් බඳුන්',icon:'🧀',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Colander',category:'කෑම් බඳුන්',icon:'🍝',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:35,image:null},
    {name:'Mixing Bowl Set 3pk',category:'කෑම් බඳුන්',icon:'🥣',retailPrice:580,wholesalePrice:495,costPrice:435,stock:500,lowStock:20,image:null},
    {name:'Measuring Cups Set',category:'කෑම් බඳුන්',icon:'🥄',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Rolling Pin',category:'කෑම් බඳුන්',icon:'🥖',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1000,lowStock:40,image:null},
    {name:'Potting Mix 5L',category:'ශාක හා උයන',icon:'🌱',retailPrice:380,wholesalePrice:322,costPrice:282,stock:500,lowStock:20,image:null},
    {name:'Fertilizer 1kg',category:'ශාක හා උයන',icon:'🌿',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:35,image:null},
    {name:'Pesticide Spray 500ml',category:'ශාක හා උයන',icon:'🌿',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:35,image:null},
    {name:'Flower Seeds (pack)',category:'ශාක හා උයන',icon:'🌸',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Vegetable Seeds (pack)',category:'ශාක හා උයන',icon:'🥬',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Herb Seeds Basil',category:'ශාක හා උයන',icon:'🌿',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Plant Pot 20cm',category:'ශාක හා උයන',icon:'🪴',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Garden Gloves',category:'ශාක හා උයන',icon:'🧤',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Watering Can 5L',category:'ශාක හා උයන',icon:'💧',retailPrice:480,wholesalePrice:408,costPrice:358,stock:500,lowStock:20,image:null},
    {name:'Garden Trowel',category:'ශාක හා උයන',icon:'⛏️',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:35,image:null},
    {name:'Dog Food 1kg',category:'සුරතල් ශාඛා',icon:'🐕',retailPrice:580,wholesalePrice:495,costPrice:435,stock:800,lowStock:30,image:null},
    {name:'Cat Food 1kg',category:'සුරතල් ශාඛා',icon:'🐈',retailPrice:520,wholesalePrice:442,costPrice:388,stock:800,lowStock:30,image:null},
    {name:'Pet Treats 200g',category:'සුරතල් ශාඛා',icon:'🦴',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Cat Litter 5L',category:'සුරතල් ශාඛා',icon:'🐈',retailPrice:380,wholesalePrice:322,costPrice:282,stock:500,lowStock:20,image:null},
    {name:'Dog Collar',category:'සුරතල් ශාඛා',icon:'🐕',retailPrice:280,wholesalePrice:238,costPrice:208,stock:500,lowStock:20,image:null},
    {name:'Pet Shampoo 200ml',category:'සුරතල් ශාඛා',icon:'🐾',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:35,image:null},
    {name:'Dog Leash',category:'සුරතල් ශාඛා',icon:'🐕',retailPrice:380,wholesalePrice:322,costPrice:282,stock:500,lowStock:20,image:null},
    {name:'Pet Bowl Set',category:'සුරතල් ශාඛා',icon:'🍽️',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:35,image:null},
    {name:'Fish Food 50g',category:'සුරතල් ශාඛා',icon:'🐠',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1000,lowStock:40,image:null},
    {name:'Bird Seed 500g',category:'සුරතල් ශාඛා',icon:'🐦',retailPrice:195,wholesalePrice:165,costPrice:142,stock:800,lowStock:35,image:null},
    {name:'School Bag (small)',category:'පාසල් ද්‍රව්‍ය',icon:'🎒',retailPrice:1480,wholesalePrice:1264,costPrice:1112,stock:300,lowStock:15,image:null},
    {name:'Pencil Case',category:'පාසල් ද්‍රව්‍ය',icon:'✏️',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:35,image:null},
    {name:'Ruler 30cm',category:'පාසල් ද්‍රව්‍ය',icon:'📏',retailPrice:75,wholesalePrice:62,costPrice:52,stock:2000,lowStock:80,image:null},
    {name:'Calculator Basic',category:'පාසල් ද්‍රව්‍ය',icon:'🔢',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:35,image:null},
    {name:'Geometry Box',category:'පාසල් ද්‍රව්‍ය',icon:'📐',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Drawing Book A4',category:'පාසල් ද්‍රව්‍ය',icon:'📒',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Sharpener',category:'පාසල් ද්‍රව්‍ය',icon:'✏️',retailPrice:45,wholesalePrice:35,costPrice:28,stock:3000,lowStock:150,image:null},
    {name:'Eraser (2pk)',category:'පාසල් ද්‍රව්‍ය',icon:'✏️',retailPrice:45,wholesalePrice:35,costPrice:28,stock:3000,lowStock:150,image:null},
    {name:'Compass',category:'පාසල් ද්‍රව්‍ය',icon:'📐',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Science Kit (basic)',category:'පාසල් ද්‍රව්‍ය',icon:'🔬',retailPrice:1280,wholesalePrice:1090,costPrice:960,stock:200,lowStock:10,image:null},
    {name:'Globe (small)',category:'පාසල් ද්‍රව්‍ය',icon:'🌍',retailPrice:1480,wholesalePrice:1264,costPrice:1112,stock:200,lowStock:10,image:null},
    {name:'Atlas Book',category:'පාසල් ද්‍රව්‍ය',icon:'📚',retailPrice:580,wholesalePrice:495,costPrice:435,stock:300,lowStock:15,image:null},
    {name:'Dictionary Sinhala-English',category:'පාසල් ද්‍රව්‍ය',icon:'📖',retailPrice:680,wholesalePrice:580,costPrice:510,stock:300,lowStock:15,image:null},
    {name:'Lunch Box School',category:'පාසල් ද්‍රව්‍ය',icon:'🍱',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:35,image:null},
    {name:'Water Bottle (kids)',category:'පාසල් ද්‍රව්‍ය',icon:'💧',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Engine Oil 1L',category:'වාහන ද්‍රව්‍ය',icon:'🛢️',retailPrice:880,wholesalePrice:750,costPrice:660,stock:500,lowStock:20,image:null},
    {name:'Car Air Freshener',category:'වාහන ද්‍රව්‍ය',icon:'🌸',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Tyre Inflator (small)',category:'වාහන ද්‍රව්‍ය',icon:'🚗',retailPrice:1480,wholesalePrice:1264,costPrice:1112,stock:200,lowStock:10,image:null},
    {name:'Car Wax 500g',category:'වාහන ද්‍රව්‍ය',icon:'✨',retailPrice:380,wholesalePrice:322,costPrice:282,stock:500,lowStock:20,image:null},
    {name:'Glass Cleaner Car 500ml',category:'වාහන ද්‍රව්‍ය',icon:'🚗',retailPrice:220,wholesalePrice:188,costPrice:165,stock:800,lowStock:35,image:null},
    {name:'Microfibre Cloth 3pk',category:'වාහන ද්‍රව්‍ය',icon:'🧽',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Jump Leads',category:'වාහන ද්‍රව්‍ය',icon:'🔌',retailPrice:1280,wholesalePrice:1090,costPrice:960,stock:200,lowStock:10,image:null},
    {name:'Torch LED',category:'වාහන ද්‍රව්‍ය',icon:'🔦',retailPrice:580,wholesalePrice:495,costPrice:435,stock:500,lowStock:20,image:null},
    {name:'Duct Tape 10m',category:'වාහන ද්‍රව්‍ය',icon:'📦',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'WD-40 250ml',category:'වාහන ද්‍රව්‍ය',icon:'🔧',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:35,image:null},
    {name:'Acrylic Paint Set 12pk',category:'ශිල්ප කලාව',icon:'🎨',retailPrice:580,wholesalePrice:495,costPrice:435,stock:500,lowStock:20,image:null},
    {name:'Canvas A4',category:'ශිල්ප කලාව',icon:'🖼️',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:35,image:null},
    {name:'Paintbrush Set',category:'ශිල්ප කලාව',icon:'🖌️',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Scrapbook',category:'ශිල්ප කලාව',icon:'📒',retailPrice:380,wholesalePrice:322,costPrice:282,stock:500,lowStock:20,image:null},
    {name:'Craft Scissors',category:'ශිල්ප කලාව',icon:'✂️',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Ribbon Roll 5m',category:'ශිල්ප කලාව',icon:'🎀',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Gift Wrap Paper 3m',category:'ශිල්ප කලාව',icon:'🎁',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Sticker Sheets 10pk',category:'ශිල්ප කලාව',icon:'⭐',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Foam Board A4',category:'ශිල්ප කලාව',icon:'📦',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Craft Glue 100ml',category:'ශිල්ප කලාව',icon:'🖊',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Washi Tape Set 5pk',category:'ශිල්ප කලාව',icon:'🎨',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:35,image:null},
    {name:'Origami Paper 100pk',category:'ශිල්ප කලාව',icon:'📄',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1000,lowStock:40,image:null},
    {name:'Kassada Decoction 200ml',category:'ශ්‍රී ලාංකීය ද්‍රව',icon:'🌿',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1000,lowStock:40,image:null},
    {name:'Gotukola Juice 200ml',category:'ශ්‍රී ලාංකීය ද්‍රව',icon:'🌿',retailPrice:120,wholesalePrice:98,costPrice:82,stock:1200,lowStock:50,image:null},
    {name:'Beli Mal Juice 200ml',category:'ශ්‍රී ලාංකීය ද්‍රව',icon:'🌸',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1000,lowStock:40,image:null},
    {name:'Thambili (King Coconut) each',category:'ශ්‍රී ලාංකීය ද්‍රව',icon:'🥥',retailPrice:95,wholesalePrice:75,costPrice:62,stock:2000,lowStock:80,image:null},
    {name:'Woodapple Juice 500ml',category:'ශ්‍රී ලාංකීය ද්‍රව',icon:'🍈',retailPrice:195,wholesalePrice:165,costPrice:142,stock:800,lowStock:35,image:null},
    {name:'Tamarind Drink 500ml',category:'ශ්‍රී ලාංකීය ද්‍රව',icon:'🫙',retailPrice:165,wholesalePrice:140,costPrice:120,stock:800,lowStock:35,image:null},
    {name:'Coriander Water 500ml',category:'ශ්‍රී ලාංකීය ද්‍රව',icon:'🌿',retailPrice:120,wholesalePrice:98,costPrice:82,stock:1000,lowStock:40,image:null},
    {name:'Ranawara Tea 20pk',category:'ශ්‍රී ලාංකීය ද්‍රව',icon:'🍵',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Iramusu Tea 20pk',category:'ශ්‍රී ලාංකීය ද්‍රව',icon:'🍵',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Nelli Juice 500ml',category:'ශ්‍රී ලාංකීය ද්‍රව',icon:'🌿',retailPrice:165,wholesalePrice:140,costPrice:120,stock:800,lowStock:35,image:null},
    {name:'Ginger Beer 330ml',category:'ශ්‍රී ලාංකීය ද්‍රව',icon:'🍺',retailPrice:120,wholesalePrice:98,costPrice:82,stock:2000,lowStock:80,image:null},
    {name:'Lion Soda 330ml',category:'ශ්‍රී ලාංකීය ද්‍රව',icon:'🥤',retailPrice:85,wholesalePrice:68,costPrice:56,stock:3000,lowStock:150,image:null},
    {name:'Tabasco 60ml',category:'ගෝරෝ හා සෝස්',icon:'🌶',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:35,image:null},
    {name:'Sriracha 250ml',category:'ගෝරෝ හා සෝස්',icon:'🌶',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'BBQ Sauce 300g',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1000,lowStock:40,image:null},
    {name:'Sweet Chilli Sauce 300g',category:'ගෝරෝ හා සෝස්',icon:'🌶',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1200,lowStock:50,image:null},
    {name:'Teriyaki Sauce 200ml',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:35,image:null},
    {name:'Oyster Sauce 200ml',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1000,lowStock:40,image:null},
    {name:'Fish Sauce 200ml',category:'ගෝරෝ හා සෝස්',icon:'🐟',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1000,lowStock:40,image:null},
    {name:'Plum Sauce 200ml',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:220,wholesalePrice:188,costPrice:165,stock:800,lowStock:35,image:null},
    {name:'Hoisin Sauce 200ml',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:220,wholesalePrice:188,costPrice:165,stock:800,lowStock:35,image:null},
    {name:'Tahini 250g',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:480,wholesalePrice:408,costPrice:358,stock:500,lowStock:20,image:null},
    {name:'Hummus 200g',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:320,wholesalePrice:272,costPrice:238,stock:800,lowStock:35,image:null},
    {name:'Pesto 190g',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:35,image:null},
    {name:'Caesar Dressing 250ml',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:35,image:null},
    {name:'Ranch Dressing 250ml',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:35,image:null},
    {name:'Balsamic Vinegar 250ml',category:'ගෝරෝ හා සෝස්',icon:'🍶',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:35,image:null},
    {name:'Honey 500g',category:'ගෝරෝ හා සෝස්',icon:'🍯',retailPrice:520,wholesalePrice:442,costPrice:388,stock:1000,lowStock:40,image:null},
    {name:'Strawberry Jam 450g',category:'ගෝරෝ හා සෝස්',icon:'🍓',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1200,lowStock:50,image:null},
    {name:'Marmalade 450g',category:'ගෝරෝ හා සෝස්',icon:'🍊',retailPrice:265,wholesalePrice:225,costPrice:198,stock:1000,lowStock:40,image:null},
    {name:'Peanut Butter 500g',category:'ගෝරෝ හා සෝස්',icon:'🥜',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1000,lowStock:40,image:null},
    {name:'Nutella 400g',category:'ගෝරෝ හා සෝස්',icon:'🍫',retailPrice:520,wholesalePrice:442,costPrice:388,stock:800,lowStock:35,image:null},
    {name:'Spaghetti 500g',category:'නූඩ්ල්ස් හා Pasta',icon:'🍝',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Penne 500g',category:'නූඩ්ල්ස් හා Pasta',icon:'🍝',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Fettuccine 500g',category:'නූඩ්ල්ස් හා Pasta',icon:'🍝',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Macaroni 500g',category:'නූඩ්ල්ස් හා Pasta',icon:'🍝',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1500,lowStock:60,image:null},
    {name:'Lasagne Sheets 250g',category:'නූඩ්ල්ස් හා Pasta',icon:'🍝',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Instant Noodles (pk)',category:'නූඩ්ල්ස් හා Pasta',icon:'🍜',retailPrice:55,wholesalePrice:45,costPrice:38,stock:5000,lowStock:200,image:null},
    {name:'Maggi Noodles 5pk',category:'නූඩ්ල්ස් හා Pasta',icon:'🍜',retailPrice:220,wholesalePrice:188,costPrice:165,stock:2000,lowStock:80,image:null},
    {name:'Egg Noodles 250g',category:'නූඩ්ල්ස් හා Pasta',icon:'🍜',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Rice Vermicelli 200g',category:'නූඩ්ල්ස් හා Pasta',icon:'🍜',retailPrice:120,wholesalePrice:100,costPrice:85,stock:1500,lowStock:60,image:null},
    {name:'Udon Noodles 250g',category:'නූඩ්ල්ස් හා Pasta',icon:'🍜',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Soba Noodles 250g',category:'නූඩ්ල්ස් හා Pasta',icon:'🍜',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1000,lowStock:40,image:null},
    {name:'Cup Noodles',category:'නූඩ්ල්ස් හා Pasta',icon:'🍜',retailPrice:120,wholesalePrice:98,costPrice:82,stock:3000,lowStock:150,image:null},
    {name:'Pasta Sauce 400g (jar)',category:'නූඩ්ල්ස් හා Pasta',icon:'🍅',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1500,lowStock:60,image:null},
    {name:'Bolognese Sauce 400g',category:'නූඩ්ල්ස් හා Pasta',icon:'🍅',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Pesto Pasta Sauce 195g',category:'නූඩ්ල්ස් හා Pasta',icon:'🫙',retailPrice:320,wholesalePrice:272,costPrice:238,stock:800,lowStock:35,image:null},
    {name:'Baked Beans 400g',category:'ටින් හා සංරක්ෂිත',icon:'🫘',retailPrice:165,wholesalePrice:140,costPrice:120,stock:2000,lowStock:80,image:null},
    {name:'Kidney Beans 400g',category:'ටින් හා සංරක්ෂිත',icon:'🫘',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Chickpeas 400g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🫘',retailPrice:165,wholesalePrice:140,costPrice:120,stock:2000,lowStock:80,image:null},
    {name:'Corn 400g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🌽',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Mushrooms 400g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🍄',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Tomato Paste 400g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🍅',retailPrice:120,wholesalePrice:98,costPrice:82,stock:2000,lowStock:80,image:null},
    {name:'Diced Tomatoes 400g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🍅',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Coconut Milk 400g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🥥',retailPrice:195,wholesalePrice:165,costPrice:142,stock:2000,lowStock:80,image:null},
    {name:'Mango Pulp 450g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🥭',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1500,lowStock:60,image:null},
    {name:'Lychee 565g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🍒',retailPrice:220,wholesalePrice:188,costPrice:165,stock:1000,lowStock:40,image:null},
    {name:'Peaches 415g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🍑',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Pineapple Chunks 420g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🍍',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1200,lowStock:50,image:null},
    {name:'Green Peas 400g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🫘',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Mixed Vegetables 400g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🥦',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Soup Tomato 400g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🍅',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1500,lowStock:60,image:null},
    {name:'Soup Chicken 400g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🍗',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Tuna in Brine 185g',category:'ටින් හා සංරක්ෂිත',icon:'🐟',retailPrice:280,wholesalePrice:238,costPrice:208,stock:2000,lowStock:80,image:null},
    {name:'Tuna in Olive Oil 185g',category:'ටින් හා සංරක්ෂිත',icon:'🐟',retailPrice:320,wholesalePrice:272,costPrice:238,stock:1500,lowStock:60,image:null},
    {name:'Salmon 200g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🐟',retailPrice:380,wholesalePrice:322,costPrice:282,stock:1000,lowStock:40,image:null},
    {name:'Spam 340g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🥩',retailPrice:480,wholesalePrice:408,costPrice:358,stock:800,lowStock:35,image:null},
    {name:'Strawberry Juice 200ml',category:'පාන',icon:'🍹',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Strawberry Cordial 750ml',category:'පාන',icon:'🍹',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Mango Juice 200ml',category:'පාන',icon:'🍹',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Mango Cordial 750ml',category:'පාන',icon:'🍹',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Grape Juice 200ml',category:'පාන',icon:'🍹',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Grape Cordial 750ml',category:'පාන',icon:'🍹',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Lemon Juice 200ml',category:'පාන',icon:'🍹',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Lemon Cordial 750ml',category:'පාන',icon:'🍹',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Guava Juice 200ml',category:'පාන',icon:'🍹',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Guava Cordial 750ml',category:'පාන',icon:'🍹',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Passion Juice 200ml',category:'පාන',icon:'🍹',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Passion Cordial 750ml',category:'පාන',icon:'🍹',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Pineapple Juice 200ml',category:'පාන',icon:'🍹',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Pineapple Cordial 750ml',category:'පාන',icon:'🍹',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Watermelon Juice 200ml',category:'පාන',icon:'🍹',retailPrice:95,wholesalePrice:78,costPrice:65,stock:2000,lowStock:80,image:null},
    {name:'Watermelon Cordial 750ml',category:'පාන',icon:'🍹',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1000,lowStock:40,image:null},
    {name:'Coca-Cola 2L',category:'පාන',icon:'🥤',retailPrice:320,wholesalePrice:272,costPrice:238,stock:1500,lowStock:60,image:null},
    {name:'Pepsi 2L',category:'පාන',icon:'🥤',retailPrice:320,wholesalePrice:272,costPrice:238,stock:1500,lowStock:60,image:null},
    {name:'Sprite 2L',category:'පාන',icon:'🥤',retailPrice:320,wholesalePrice:272,costPrice:238,stock:1500,lowStock:60,image:null},
    {name:'Fanta 2L',category:'පාන',icon:'🥤',retailPrice:320,wholesalePrice:272,costPrice:238,stock:1500,lowStock:60,image:null},
    {name:'Lipton Tea 100pk',category:'පාන',icon:'🍵',retailPrice:580,wholesalePrice:495,costPrice:435,stock:800,lowStock:30,image:null},
    {name:'Dilmah Tea 100pk',category:'පාන',icon:'🍵',retailPrice:580,wholesalePrice:495,costPrice:435,stock:800,lowStock:30,image:null},
    {name:'Zesta Tea 100pk',category:'පාන',icon:'🍵',retailPrice:580,wholesalePrice:495,costPrice:435,stock:800,lowStock:30,image:null},
    {name:'Strawberry Yogurt 100g',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:75,wholesalePrice:62,costPrice:52,stock:2000,lowStock:80,image:null},
    {name:'Strawberry Flavoured Milk 200ml',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:110,wholesalePrice:90,costPrice:75,stock:2000,lowStock:80,image:null},
    {name:'Chocolate Yogurt 100g',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:75,wholesalePrice:62,costPrice:52,stock:2000,lowStock:80,image:null},
    {name:'Chocolate Flavoured Milk 200ml',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:110,wholesalePrice:90,costPrice:75,stock:2000,lowStock:80,image:null},
    {name:'Vanilla Yogurt 100g',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:75,wholesalePrice:62,costPrice:52,stock:2000,lowStock:80,image:null},
    {name:'Vanilla Flavoured Milk 200ml',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:110,wholesalePrice:90,costPrice:75,stock:2000,lowStock:80,image:null},
    {name:'Mango Yogurt 100g',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:75,wholesalePrice:62,costPrice:52,stock:2000,lowStock:80,image:null},
    {name:'Mango Flavoured Milk 200ml',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:110,wholesalePrice:90,costPrice:75,stock:2000,lowStock:80,image:null},
    {name:'Banana Yogurt 100g',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:75,wholesalePrice:62,costPrice:52,stock:2000,lowStock:80,image:null},
    {name:'Banana Flavoured Milk 200ml',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:110,wholesalePrice:90,costPrice:75,stock:2000,lowStock:80,image:null},
    {name:'Chips Cheese 75g',category:'ස්නැක්ස්',icon:'🍿',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Chips BBQ 75g',category:'ස්නැක්ස්',icon:'🍿',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Chips Salt Vinegar 75g',category:'ස්නැක්ස්',icon:'🍿',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Chips Sour Cream 75g',category:'ස්නැක්ස්',icon:'🍿',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Chips Jalapeno 75g',category:'ස්නැක්ස්',icon:'🍿',retailPrice:145,wholesalePrice:122,costPrice:105,stock:2000,lowStock:80,image:null},
    {name:'Dark Chocolate 100g',category:'ස්නැක්ස්',icon:'🍫',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'White Chocolate 100g',category:'ස්නැක්ස්',icon:'🍫',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'Almond Chocolate 100g',category:'ස්නැක්ස්',icon:'🍫',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'Hazelnut Chocolate 100g',category:'ස්නැක්ස්',icon:'🍫',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'Mint Chocolate 100g',category:'ස්නැක්ස්',icon:'🍫',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'Cream Cheese Biscuits 150g',category:'ස්නැක්ස්',icon:'🍪',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Peanut Butter Biscuits 150g',category:'ස්නැක්ස්',icon:'🍪',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Caramel Biscuits 150g',category:'ස්නැක්ස්',icon:'🍪',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'Fresh Dill 50g',category:'එළවළු',icon:'🌿',retailPrice:95,wholesalePrice:78,costPrice:65,stock:1000,lowStock:50,image:null},
    {name:'Fresh Parsley 50g',category:'එළවළු',icon:'🌿',retailPrice:95,wholesalePrice:78,costPrice:65,stock:1000,lowStock:50,image:null},
    {name:'Fresh Mint 50g',category:'එළවළු',icon:'🌿',retailPrice:95,wholesalePrice:78,costPrice:65,stock:1000,lowStock:50,image:null},
    {name:'Fresh Thyme 50g',category:'එළවළු',icon:'🌿',retailPrice:95,wholesalePrice:78,costPrice:65,stock:1000,lowStock:50,image:null},
    {name:'Fresh Oregano 50g',category:'එළවළු',icon:'🌿',retailPrice:95,wholesalePrice:78,costPrice:65,stock:1000,lowStock:50,image:null},
    {name:'Fresh Basil 50g',category:'එළවළු',icon:'🌿',retailPrice:95,wholesalePrice:78,costPrice:65,stock:1000,lowStock:50,image:null},
    {name:'Fresh Coriander 50g',category:'එළවළු',icon:'🌿',retailPrice:95,wholesalePrice:78,costPrice:65,stock:1000,lowStock:50,image:null},
    {name:'Fresh Rosemary 50g',category:'එළවළු',icon:'🌿',retailPrice:95,wholesalePrice:78,costPrice:65,stock:1000,lowStock:50,image:null},
    {name:'ගොරකා 250g',category:'එළවළු',icon:'🥬',retailPrice:110,wholesalePrice:90,costPrice:75,stock:800,lowStock:35,image:null},
    {name:'ශිතල කිව්ව 250g',category:'එළවළු',icon:'🥬',retailPrice:110,wholesalePrice:90,costPrice:75,stock:800,lowStock:35,image:null},
    {name:'ශිතල ශිතිකා 250g',category:'එළවළු',icon:'🥬',retailPrice:110,wholesalePrice:90,costPrice:75,stock:800,lowStock:35,image:null},
    {name:'ෆ්‍රෙෂ් ජීවන් 250g',category:'එළවළු',icon:'🥬',retailPrice:110,wholesalePrice:90,costPrice:75,stock:800,lowStock:35,image:null},
    {name:'කොළ සලාද 250g',category:'එළවළු',icon:'🥬',retailPrice:110,wholesalePrice:90,costPrice:75,stock:800,lowStock:35,image:null},
    {name:'Dove Soap 100g',category:'පෞද්ගලික සෙනෙහස',icon:'🧼',retailPrice:95,wholesalePrice:78,costPrice:65,stock:3000,lowStock:150,image:null},
    {name:'Lux Soap 100g',category:'පෞද්ගලික සෙනෙහස',icon:'🧼',retailPrice:95,wholesalePrice:78,costPrice:65,stock:3000,lowStock:150,image:null},
    {name:'Lifebuoy Soap 100g',category:'පෞද්ගලික සෙනෙහස',icon:'🧼',retailPrice:95,wholesalePrice:78,costPrice:65,stock:3000,lowStock:150,image:null},
    {name:'Palmolive Soap 100g',category:'පෞද්ගලික සෙනෙහස',icon:'🧼',retailPrice:95,wholesalePrice:78,costPrice:65,stock:3000,lowStock:150,image:null},
    {name:'Hamam Soap 100g',category:'පෞද්ගලික සෙනෙහස',icon:'🧼',retailPrice:95,wholesalePrice:78,costPrice:65,stock:3000,lowStock:150,image:null},
    {name:'Pantene Conditioner 200ml',category:'පෞද්ගලික සෙනෙහස',icon:'💆',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'Sunsilk Conditioner 200ml',category:'පෞද්ගලික සෙනෙහස',icon:'💆',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'Garnier Conditioner 200ml',category:'පෞද්ගලික සෙනෙහස',icon:'💆',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'TRESemme Conditioner 200ml',category:'පෞද්ගලික සෙනෙහස',icon:'💆',retailPrice:280,wholesalePrice:238,costPrice:208,stock:1500,lowStock:60,image:null},
    {name:'Surf Washing Powder 2kg',category:'ගෘහ භාණ්ඩ',icon:'🧺',retailPrice:680,wholesalePrice:580,costPrice:510,stock:1000,lowStock:40,image:null},
    {name:'OMO Washing Powder 2kg',category:'ගෘහ භාණ්ඩ',icon:'🧺',retailPrice:680,wholesalePrice:580,costPrice:510,stock:1000,lowStock:40,image:null},
    {name:'Tide Washing Powder 2kg',category:'ගෘහ භාණ්ඩ',icon:'🧺',retailPrice:680,wholesalePrice:580,costPrice:510,stock:1000,lowStock:40,image:null},
    {name:'Persil Washing Powder 2kg',category:'ගෘහ භාණ්ඩ',icon:'🧺',retailPrice:680,wholesalePrice:580,costPrice:510,stock:1000,lowStock:40,image:null},
    {name:'Bleach 500ml',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:95,wholesalePrice:77,costPrice:66,stock:1000,lowStock:40,image:null},
    {name:'Bleach 1L',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:165,wholesalePrice:135,costPrice:115,stock:1000,lowStock:40,image:null},
    {name:'Bleach 2L',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:295,wholesalePrice:241,costPrice:206,stock:1000,lowStock:40,image:null},
    {name:'Bleach 5L',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:680,wholesalePrice:557,costPrice:475,stock:1000,lowStock:40,image:null},
    {name:'Pepper Powder 50g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Pepper Whole 50g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1200,lowStock:50,image:null},
    {name:'Paprika Powder 50g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Paprika Whole 50g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1200,lowStock:50,image:null},
    {name:'Nutmeg Powder 50g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Nutmeg Whole 50g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1200,lowStock:50,image:null},
    {name:'Fenugreek Powder 50g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Fenugreek Whole 50g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1200,lowStock:50,image:null},
    {name:'Fennel Powder 50g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Fennel Whole 50g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1200,lowStock:50,image:null},
    {name:'Cardamom Powder 50g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Cardamom Whole 50g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1200,lowStock:50,image:null},
    {name:'Anise Powder 50g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Anise Whole 50g',category:'ඉවුම් පිහුම්',icon:'🌿',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1200,lowStock:50,image:null},
    {name:'Maggi Chicken Stock 10pk',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:120,wholesalePrice:98,costPrice:82,stock:2000,lowStock:80,image:null},
    {name:'Maggi Beef Stock 10pk',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:120,wholesalePrice:98,costPrice:82,stock:2000,lowStock:80,image:null},
    {name:'Maggi Vegetable Stock 10pk',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:120,wholesalePrice:98,costPrice:82,stock:2000,lowStock:80,image:null},
    {name:'Maggi Fish Stock 10pk',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:120,wholesalePrice:98,costPrice:82,stock:2000,lowStock:80,image:null},
    {name:'Knorr Chicken Stock 10pk',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:120,wholesalePrice:98,costPrice:82,stock:2000,lowStock:80,image:null},
    {name:'Knorr Beef Stock 10pk',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:120,wholesalePrice:98,costPrice:82,stock:2000,lowStock:80,image:null},
    {name:'Knorr Vegetable Stock 10pk',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:120,wholesalePrice:98,costPrice:82,stock:2000,lowStock:80,image:null},
    {name:'Knorr Fish Stock 10pk',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:120,wholesalePrice:98,costPrice:82,stock:2000,lowStock:80,image:null},
    {name:'Royco Chicken Stock 10pk',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:120,wholesalePrice:98,costPrice:82,stock:2000,lowStock:80,image:null},
    {name:'Royco Beef Stock 10pk',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:120,wholesalePrice:98,costPrice:82,stock:2000,lowStock:80,image:null},
    {name:'Royco Vegetable Stock 10pk',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:120,wholesalePrice:98,costPrice:82,stock:2000,lowStock:80,image:null},
    {name:'Royco Fish Stock 10pk',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:120,wholesalePrice:98,costPrice:82,stock:2000,lowStock:80,image:null},
    {name:'ජැස්මින් සහල් 1kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'ජැස්මින් සහල් 5kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:920,wholesalePrice:782,costPrice:684,stock:800,lowStock:30,image:null},
    {name:'බ්‍රවුන් සහල් 1kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'බ්‍රවුන් සහල් 5kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:920,wholesalePrice:782,costPrice:684,stock:800,lowStock:30,image:null},
    {name:'කළු සහල් 1kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'කළු සහල් 5kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:920,wholesalePrice:782,costPrice:684,stock:800,lowStock:30,image:null},
    {name:'ල්ශ්‍රී සහල් 1kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'ල්ශ්‍රී සහල් 5kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:920,wholesalePrice:782,costPrice:684,stock:800,lowStock:30,image:null},
    {name:'ස්ශ්‍රී සහල් 1kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'ස්ශ්‍රී සහල් 5kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:920,wholesalePrice:782,costPrice:684,stock:800,lowStock:30,image:null},
    {name:'ජාපන් සහල් 1kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1500,lowStock:60,image:null},
    {name:'ජාපන් සහල් 5kg',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:920,wholesalePrice:782,costPrice:684,stock:800,lowStock:30,image:null},
    {name:'Vanilla Ice Cream 500ml',category:'ශිතල හා Frozen',icon:'🍦',retailPrice:380,wholesalePrice:322,costPrice:282,stock:600,lowStock:25,image:null},
    {name:'Vanilla Gelato 500ml',category:'ශිතල හා Frozen',icon:'🍨',retailPrice:520,wholesalePrice:442,costPrice:388,stock:400,lowStock:15,image:null},
    {name:'Chocolate Ice Cream 500ml',category:'ශිතල හා Frozen',icon:'🍦',retailPrice:380,wholesalePrice:322,costPrice:282,stock:600,lowStock:25,image:null},
    {name:'Chocolate Gelato 500ml',category:'ශිතල හා Frozen',icon:'🍨',retailPrice:520,wholesalePrice:442,costPrice:388,stock:400,lowStock:15,image:null},
    {name:'Strawberry Ice Cream 500ml',category:'ශිතල හා Frozen',icon:'🍦',retailPrice:380,wholesalePrice:322,costPrice:282,stock:600,lowStock:25,image:null},
    {name:'Strawberry Gelato 500ml',category:'ශිතල හා Frozen',icon:'🍨',retailPrice:520,wholesalePrice:442,costPrice:388,stock:400,lowStock:15,image:null},
    {name:'Mango Ice Cream 500ml',category:'ශිතල හා Frozen',icon:'🍦',retailPrice:380,wholesalePrice:322,costPrice:282,stock:600,lowStock:25,image:null},
    {name:'Mango Gelato 500ml',category:'ශිතල හා Frozen',icon:'🍨',retailPrice:520,wholesalePrice:442,costPrice:388,stock:400,lowStock:15,image:null},
    {name:'Coconut Ice Cream 500ml',category:'ශිතල හා Frozen',icon:'🍦',retailPrice:380,wholesalePrice:322,costPrice:282,stock:600,lowStock:25,image:null},
    {name:'Coconut Gelato 500ml',category:'ශිතල හා Frozen',icon:'🍨',retailPrice:520,wholesalePrice:442,costPrice:388,stock:400,lowStock:15,image:null},
    {name:'Black Bean 400g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🫘',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1500,lowStock:60,image:null},
    {name:'Cannellini 400g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🫘',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1500,lowStock:60,image:null},
    {name:'Butter Bean 400g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🫘',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1500,lowStock:60,image:null},
    {name:'Borlotti 400g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🫘',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1500,lowStock:60,image:null},
    {name:'Adzuki 400g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🫘',retailPrice:165,wholesalePrice:140,costPrice:120,stock:1500,lowStock:60,image:null},
    {name:'Mandarin 410g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🍑',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Pear 410g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🍑',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Apricot 410g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🍑',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Cherry 410g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🍑',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Plum 410g (tin)',category:'ටින් හා සංරක්ෂිත',icon:'🍑',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Baby Puree Apple Banana 120g',category:'ළමා ආහාර',icon:'👶',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1000,lowStock:40,image:null},
    {name:'Baby Yogurt Apple Banana 4pk',category:'ළමා ආහාර',icon:'👶',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:30,image:null},
    {name:'Baby Puree Mango 120g',category:'ළමා ආහාර',icon:'👶',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1000,lowStock:40,image:null},
    {name:'Baby Yogurt Mango 4pk',category:'ළමා ආහාර',icon:'👶',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:30,image:null},
    {name:'Baby Puree Pear 120g',category:'ළමා ආහාර',icon:'👶',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1000,lowStock:40,image:null},
    {name:'Baby Yogurt Pear 4pk',category:'ළමා ආහාර',icon:'👶',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:30,image:null},
    {name:'Baby Puree Sweet Potato 120g',category:'ළමා ආහාර',icon:'👶',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1000,lowStock:40,image:null},
    {name:'Baby Yogurt Sweet Potato 4pk',category:'ළමා ආහාර',icon:'👶',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:30,image:null},
    {name:'Baby Puree Pumpkin 120g',category:'ළමා ආහාර',icon:'👶',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1000,lowStock:40,image:null},
    {name:'Baby Yogurt Pumpkin 4pk',category:'ළමා ආහාර',icon:'👶',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:30,image:null},
    {name:'Baby Puree Carrot 120g',category:'ළමා ආහාර',icon:'👶',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1000,lowStock:40,image:null},
    {name:'Baby Yogurt Carrot 4pk',category:'ළමා ආහාර',icon:'👶',retailPrice:380,wholesalePrice:322,costPrice:282,stock:800,lowStock:30,image:null},
    {name:'Barilla Spaghetti 500g',category:'නූඩ්ල්ස් හා Pasta',icon:'🍝',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:30,image:null},
    {name:'Barilla Penne 500g',category:'නූඩ්ල්ස් හා Pasta',icon:'🍝',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:30,image:null},
    {name:'De Cecco Spaghetti 500g',category:'නූඩ්ල්ස් හා Pasta',icon:'🍝',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:30,image:null},
    {name:'De Cecco Penne 500g',category:'නූඩ්ල්ස් හා Pasta',icon:'🍝',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:30,image:null},
    {name:'San Remo Spaghetti 500g',category:'නූඩ්ල්ස් හා Pasta',icon:'🍝',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:30,image:null},
    {name:'San Remo Penne 500g',category:'නූඩ්ල්ස් හා Pasta',icon:'🍝',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:30,image:null},
    {name:'Divella Spaghetti 500g',category:'නූඩ්ල්ස් හා Pasta',icon:'🍝',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:30,image:null},
    {name:'Divella Penne 500g',category:'නූඩ්ල්ස් හා Pasta',icon:'🍝',retailPrice:280,wholesalePrice:238,costPrice:208,stock:800,lowStock:30,image:null},
    {name:'Chicken Cup Noodles',category:'නූඩ්ල්ස් හා Pasta',icon:'🍜',retailPrice:145,wholesalePrice:122,costPrice:105,stock:3000,lowStock:150,image:null},
    {name:'Chicken Instant Noodles 5pk',category:'නූඩ්ල්ස් හා Pasta',icon:'🍜',retailPrice:280,wholesalePrice:238,costPrice:208,stock:2000,lowStock:80,image:null},
    {name:'Tom Yum Cup Noodles',category:'නූඩ්ල්ස් හා Pasta',icon:'🍜',retailPrice:145,wholesalePrice:122,costPrice:105,stock:3000,lowStock:150,image:null},
    {name:'Tom Yum Instant Noodles 5pk',category:'නූඩ්ල්ස් හා Pasta',icon:'🍜',retailPrice:280,wholesalePrice:238,costPrice:208,stock:2000,lowStock:80,image:null},
    {name:'Beef Cup Noodles',category:'නූඩ්ල්ස් හා Pasta',icon:'🍜',retailPrice:145,wholesalePrice:122,costPrice:105,stock:3000,lowStock:150,image:null},
    {name:'Beef Instant Noodles 5pk',category:'නූඩ්ල්ස් හා Pasta',icon:'🍜',retailPrice:280,wholesalePrice:238,costPrice:208,stock:2000,lowStock:80,image:null},
    {name:'Seafood Cup Noodles',category:'නූඩ්ල්ස් හා Pasta',icon:'🍜',retailPrice:145,wholesalePrice:122,costPrice:105,stock:3000,lowStock:150,image:null},
    {name:'Seafood Instant Noodles 5pk',category:'නූඩ්ල්ස් හා Pasta',icon:'🍜',retailPrice:280,wholesalePrice:238,costPrice:208,stock:2000,lowStock:80,image:null},
    {name:'Curry Cup Noodles',category:'නූඩ්ල්ස් හා Pasta',icon:'🍜',retailPrice:145,wholesalePrice:122,costPrice:105,stock:3000,lowStock:150,image:null},
    {name:'Curry Instant Noodles 5pk',category:'නූඩ්ල්ස් හා Pasta',icon:'🍜',retailPrice:280,wholesalePrice:238,costPrice:208,stock:2000,lowStock:80,image:null},
    {name:'Mango Chutney 250g',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:220,wholesalePrice:188,costPrice:165,stock:800,lowStock:35,image:null},
    {name:'Mango Pickle 300g',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Tamarind Chutney 250g',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:220,wholesalePrice:188,costPrice:165,stock:800,lowStock:35,image:null},
    {name:'Tamarind Pickle 300g',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Lime Chutney 250g',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:220,wholesalePrice:188,costPrice:165,stock:800,lowStock:35,image:null},
    {name:'Lime Pickle 300g',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Green Chilli Chutney 250g',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:220,wholesalePrice:188,costPrice:165,stock:800,lowStock:35,image:null},
    {name:'Green Chilli Pickle 300g',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Red Chilli Chutney 250g',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:220,wholesalePrice:188,costPrice:165,stock:800,lowStock:35,image:null},
    {name:'Red Chilli Pickle 300g',category:'ගෝරෝ හා සෝස්',icon:'🫙',retailPrice:195,wholesalePrice:165,costPrice:142,stock:1000,lowStock:40,image:null},
    {name:'Kurakkan Flour 500g',category:'ශ්‍රී ලාංකීය',icon:'🌾',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Kurakkan Roti Mix 500g',category:'ශ්‍රී ලාංකීය',icon:'🌾',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Pittu Flour 500g',category:'ශ්‍රී ලාංකීය',icon:'🌾',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Appa Mix 500g',category:'ශ්‍රී ලාංකීය',icon:'🌾',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'Kottu Mix 500g',category:'ශ්‍රී ලාංකීය',icon:'🌾',retailPrice:145,wholesalePrice:122,costPrice:105,stock:1500,lowStock:60,image:null},
    {name:'ශිතල ගොරොම්බා 500g',category:'ශ්‍රී ලාංකීය',icon:'🍜',retailPrice:320,wholesalePrice:272,costPrice:238,stock:800,lowStock:30,image:null},
    {name:'ශිතල මාළු ඇඹරැල්ල 400g',category:'ශ්‍රී ලාංකීය',icon:'🍜',retailPrice:320,wholesalePrice:272,costPrice:238,stock:800,lowStock:30,image:null},
    {name:'ශිතල ඉස්සෝ සම්බෝල 200g',category:'ශ්‍රී ලාංකීය',icon:'🍜',retailPrice:320,wholesalePrice:272,costPrice:238,stock:800,lowStock:30,image:null},
    {name:'ධාන්‍ය-🌾-001',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:125,wholesalePrice:106,costPrice:93,stock:530,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-002',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:130,wholesalePrice:110,costPrice:97,stock:560,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-003',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:135,wholesalePrice:114,costPrice:101,stock:590,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-004',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:140,wholesalePrice:119,costPrice:105,stock:620,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-005',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:145,wholesalePrice:123,costPrice:108,stock:650,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-006',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:150,wholesalePrice:127,costPrice:112,stock:680,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-007',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:155,wholesalePrice:131,costPrice:116,stock:710,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-008',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:160,wholesalePrice:136,costPrice:120,stock:740,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-009',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:165,wholesalePrice:140,costPrice:123,stock:770,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-010',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:170,wholesalePrice:144,costPrice:127,stock:800,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-011',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:175,wholesalePrice:148,costPrice:131,stock:830,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-012',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:180,wholesalePrice:153,costPrice:135,stock:860,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-013',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:185,wholesalePrice:157,costPrice:138,stock:890,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-014',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:190,wholesalePrice:161,costPrice:142,stock:920,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-015',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:195,wholesalePrice:165,costPrice:146,stock:950,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-016',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:200,wholesalePrice:170,costPrice:150,stock:980,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-017',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:205,wholesalePrice:174,costPrice:153,stock:1010,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-018',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:210,wholesalePrice:178,costPrice:157,stock:1040,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-019',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:215,wholesalePrice:182,costPrice:161,stock:1070,lowStock:20,image:null},
    {name:'ධාන්‍ය-🌾-020',category:'ධාන්‍ය හා සහල්',icon:'🌾',retailPrice:220,wholesalePrice:187,costPrice:165,stock:1100,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-001',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:285,wholesalePrice:242,costPrice:213,stock:530,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-002',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:290,wholesalePrice:246,costPrice:217,stock:560,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-003',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:295,wholesalePrice:250,costPrice:221,stock:590,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-004',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:300,wholesalePrice:255,costPrice:225,stock:620,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-005',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:305,wholesalePrice:259,costPrice:228,stock:650,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-006',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:310,wholesalePrice:263,costPrice:232,stock:680,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-007',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:315,wholesalePrice:267,costPrice:236,stock:710,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-008',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:320,wholesalePrice:272,costPrice:240,stock:740,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-009',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:325,wholesalePrice:276,costPrice:243,stock:770,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-010',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:330,wholesalePrice:280,costPrice:247,stock:800,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-011',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:335,wholesalePrice:284,costPrice:251,stock:830,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-012',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:340,wholesalePrice:289,costPrice:255,stock:860,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-013',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:345,wholesalePrice:293,costPrice:258,stock:890,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-014',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:350,wholesalePrice:297,costPrice:262,stock:920,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-015',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:355,wholesalePrice:301,costPrice:266,stock:950,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-016',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:360,wholesalePrice:306,costPrice:270,stock:980,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-017',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:365,wholesalePrice:310,costPrice:273,stock:1010,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-018',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:370,wholesalePrice:314,costPrice:277,stock:1040,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-019',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:375,wholesalePrice:318,costPrice:281,stock:1070,lowStock:20,image:null},
    {name:'ශිතල හ-🧊-020',category:'ශිතල හා Frozen',icon:'🧊',retailPrice:380,wholesalePrice:323,costPrice:285,stock:1100,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-001',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:155,wholesalePrice:131,costPrice:116,stock:530,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-002',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:160,wholesalePrice:136,costPrice:120,stock:560,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-003',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:165,wholesalePrice:140,costPrice:123,stock:590,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-004',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:170,wholesalePrice:144,costPrice:127,stock:620,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-005',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:175,wholesalePrice:148,costPrice:131,stock:650,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-006',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:180,wholesalePrice:153,costPrice:135,stock:680,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-007',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:185,wholesalePrice:157,costPrice:138,stock:710,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-008',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:190,wholesalePrice:161,costPrice:142,stock:740,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-009',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:195,wholesalePrice:165,costPrice:146,stock:770,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-010',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:200,wholesalePrice:170,costPrice:150,stock:800,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-011',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:205,wholesalePrice:174,costPrice:153,stock:830,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-012',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:210,wholesalePrice:178,costPrice:157,stock:860,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-013',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:215,wholesalePrice:182,costPrice:161,stock:890,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-014',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:220,wholesalePrice:187,costPrice:165,stock:920,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-015',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:225,wholesalePrice:191,costPrice:168,stock:950,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-016',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:230,wholesalePrice:195,costPrice:172,stock:980,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-017',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:235,wholesalePrice:199,costPrice:176,stock:1010,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-018',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:240,wholesalePrice:204,costPrice:180,stock:1040,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-019',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:245,wholesalePrice:208,costPrice:183,stock:1070,lowStock:20,image:null},
    {name:'ගෘහ භා-🧴-020',category:'ගෘහ භාණ්ඩ',icon:'🧴',retailPrice:250,wholesalePrice:212,costPrice:187,stock:1100,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-001',category:'ස්නැක්ස්',icon:'🍿',retailPrice:125,wholesalePrice:106,costPrice:93,stock:530,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-002',category:'ස්නැක්ස්',icon:'🍿',retailPrice:130,wholesalePrice:110,costPrice:97,stock:560,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-003',category:'ස්නැක්ස්',icon:'🍿',retailPrice:135,wholesalePrice:114,costPrice:101,stock:590,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-004',category:'ස්නැක්ස්',icon:'🍿',retailPrice:140,wholesalePrice:119,costPrice:105,stock:620,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-005',category:'ස්නැක්ස්',icon:'🍿',retailPrice:145,wholesalePrice:123,costPrice:108,stock:650,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-006',category:'ස්නැක්ස්',icon:'🍿',retailPrice:150,wholesalePrice:127,costPrice:112,stock:680,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-007',category:'ස්නැක්ස්',icon:'🍿',retailPrice:155,wholesalePrice:131,costPrice:116,stock:710,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-008',category:'ස්නැක්ස්',icon:'🍿',retailPrice:160,wholesalePrice:136,costPrice:120,stock:740,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-009',category:'ස්නැක්ස්',icon:'🍿',retailPrice:165,wholesalePrice:140,costPrice:123,stock:770,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-010',category:'ස්නැක්ස්',icon:'🍿',retailPrice:170,wholesalePrice:144,costPrice:127,stock:800,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-011',category:'ස්නැක්ස්',icon:'🍿',retailPrice:175,wholesalePrice:148,costPrice:131,stock:830,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-012',category:'ස්නැක්ස්',icon:'🍿',retailPrice:180,wholesalePrice:153,costPrice:135,stock:860,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-013',category:'ස්නැක්ස්',icon:'🍿',retailPrice:185,wholesalePrice:157,costPrice:138,stock:890,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-014',category:'ස්නැක්ස්',icon:'🍿',retailPrice:190,wholesalePrice:161,costPrice:142,stock:920,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-015',category:'ස්නැක්ස්',icon:'🍿',retailPrice:195,wholesalePrice:165,costPrice:146,stock:950,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-016',category:'ස්නැක්ස්',icon:'🍿',retailPrice:200,wholesalePrice:170,costPrice:150,stock:980,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-017',category:'ස්නැක්ස්',icon:'🍿',retailPrice:205,wholesalePrice:174,costPrice:153,stock:1010,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-018',category:'ස්නැක්ස්',icon:'🍿',retailPrice:210,wholesalePrice:178,costPrice:157,stock:1040,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-019',category:'ස්නැක්ස්',icon:'🍿',retailPrice:215,wholesalePrice:182,costPrice:161,stock:1070,lowStock:20,image:null},
    {name:'ස්නැක්-🍿-020',category:'ස්නැක්ස්',icon:'🍿',retailPrice:220,wholesalePrice:187,costPrice:165,stock:1100,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-001',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:150,wholesalePrice:127,costPrice:112,stock:530,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-002',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:155,wholesalePrice:131,costPrice:116,stock:560,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-003',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:160,wholesalePrice:136,costPrice:120,stock:590,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-004',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:165,wholesalePrice:140,costPrice:123,stock:620,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-005',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:170,wholesalePrice:144,costPrice:127,stock:650,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-006',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:175,wholesalePrice:148,costPrice:131,stock:680,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-007',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:180,wholesalePrice:153,costPrice:135,stock:710,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-008',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:185,wholesalePrice:157,costPrice:138,stock:740,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-009',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:190,wholesalePrice:161,costPrice:142,stock:770,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-010',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:195,wholesalePrice:165,costPrice:146,stock:800,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-011',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:200,wholesalePrice:170,costPrice:150,stock:830,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-012',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:205,wholesalePrice:174,costPrice:153,stock:860,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-013',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:210,wholesalePrice:178,costPrice:157,stock:890,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-014',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:215,wholesalePrice:182,costPrice:161,stock:920,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-015',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:220,wholesalePrice:187,costPrice:165,stock:950,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-016',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:225,wholesalePrice:191,costPrice:168,stock:980,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-017',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:230,wholesalePrice:195,costPrice:172,stock:1010,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-018',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:235,wholesalePrice:199,costPrice:176,stock:1040,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-019',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:240,wholesalePrice:204,costPrice:180,stock:1070,lowStock:20,image:null},
    {name:'ඉවුම් -🫙-020',category:'ඉවුම් පිහුම්',icon:'🫙',retailPrice:245,wholesalePrice:208,costPrice:183,stock:1100,lowStock:20,image:null},
    {name:'කිරිජන-🥛-001',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:185,wholesalePrice:157,costPrice:138,stock:530,lowStock:20,image:null},
    {name:'කිරිජන-🥛-002',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:190,wholesalePrice:161,costPrice:142,stock:560,lowStock:20,image:null},
    {name:'කිරිජන-🥛-003',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:195,wholesalePrice:165,costPrice:146,stock:590,lowStock:20,image:null},
    {name:'කිරිජන-🥛-004',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:200,wholesalePrice:170,costPrice:150,stock:620,lowStock:20,image:null},
    {name:'කිරිජන-🥛-005',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:205,wholesalePrice:174,costPrice:153,stock:650,lowStock:20,image:null},
    {name:'කිරිජන-🥛-006',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:210,wholesalePrice:178,costPrice:157,stock:680,lowStock:20,image:null},
    {name:'කිරිජන-🥛-007',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:215,wholesalePrice:182,costPrice:161,stock:710,lowStock:20,image:null},
    {name:'කිරිජන-🥛-008',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:220,wholesalePrice:187,costPrice:165,stock:740,lowStock:20,image:null},
    {name:'කිරිජන-🥛-009',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:225,wholesalePrice:191,costPrice:168,stock:770,lowStock:20,image:null},
    {name:'කිරිජන-🥛-010',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:230,wholesalePrice:195,costPrice:172,stock:800,lowStock:20,image:null},
    {name:'කිරිජන-🥛-011',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:235,wholesalePrice:199,costPrice:176,stock:830,lowStock:20,image:null},
    {name:'කිරිජන-🥛-012',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:240,wholesalePrice:204,costPrice:180,stock:860,lowStock:20,image:null},
    {name:'කිරිජන-🥛-013',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:245,wholesalePrice:208,costPrice:183,stock:890,lowStock:20,image:null},
    {name:'කිරිජන-🥛-014',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:250,wholesalePrice:212,costPrice:187,stock:920,lowStock:20,image:null},
    {name:'කිරිජන-🥛-015',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:255,wholesalePrice:216,costPrice:191,stock:950,lowStock:20,image:null},
    {name:'කිරිජන-🥛-016',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:260,wholesalePrice:221,costPrice:195,stock:980,lowStock:20,image:null},
    {name:'කිරිජන-🥛-017',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:265,wholesalePrice:225,costPrice:198,stock:1010,lowStock:20,image:null},
    {name:'කිරිජන-🥛-018',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:270,wholesalePrice:229,costPrice:202,stock:1040,lowStock:20,image:null},
    {name:'කිරිජන-🥛-019',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:275,wholesalePrice:233,costPrice:206,stock:1070,lowStock:20,image:null},
    {name:'කිරිජන-🥛-020',category:'කිරිජන්‍ය',icon:'🥛',retailPrice:280,wholesalePrice:238,costPrice:210,stock:1100,lowStock:20,image:null},
    {name:'පාන-🥤-001',category:'පාන',icon:'🥤',retailPrice:115,wholesalePrice:97,costPrice:86,stock:530,lowStock:20,image:null},
    {name:'පාන-🥤-002',category:'පාන',icon:'🥤',retailPrice:120,wholesalePrice:102,costPrice:90,stock:560,lowStock:20,image:null},
    {name:'පාන-🥤-003',category:'පාන',icon:'🥤',retailPrice:125,wholesalePrice:106,costPrice:93,stock:590,lowStock:20,image:null},
    {name:'පාන-🥤-004',category:'පාන',icon:'🥤',retailPrice:130,wholesalePrice:110,costPrice:97,stock:620,lowStock:20,image:null},
    {name:'පාන-🥤-005',category:'පාන',icon:'🥤',retailPrice:135,wholesalePrice:114,costPrice:101,stock:650,lowStock:20,image:null},
    {name:'පාන-🥤-006',category:'පාන',icon:'🥤',retailPrice:140,wholesalePrice:119,costPrice:105,stock:680,lowStock:20,image:null},
    {name:'පාන-🥤-007',category:'පාන',icon:'🥤',retailPrice:145,wholesalePrice:123,costPrice:108,stock:710,lowStock:20,image:null},
    {name:'පාන-🥤-008',category:'පාන',icon:'🥤',retailPrice:150,wholesalePrice:127,costPrice:112,stock:740,lowStock:20,image:null},
    {name:'පාන-🥤-009',category:'පාන',icon:'🥤',retailPrice:155,wholesalePrice:131,costPrice:116,stock:770,lowStock:20,image:null},
    {name:'පාන-🥤-010',category:'පාන',icon:'🥤',retailPrice:160,wholesalePrice:136,costPrice:120,stock:800,lowStock:20,image:null},
    {name:'පාන-🥤-011',category:'පාන',icon:'🥤',retailPrice:165,wholesalePrice:140,costPrice:123,stock:830,lowStock:20,image:null},
    {name:'පාන-🥤-012',category:'පාන',icon:'🥤',retailPrice:170,wholesalePrice:144,costPrice:127,stock:860,lowStock:20,image:null},
    {name:'පාන-🥤-013',category:'පාන',icon:'🥤',retailPrice:175,wholesalePrice:148,costPrice:131,stock:890,lowStock:20,image:null},
    {name:'පාන-🥤-014',category:'පාන',icon:'🥤',retailPrice:180,wholesalePrice:153,costPrice:135,stock:920,lowStock:20,image:null},
    {name:'පාන-🥤-015',category:'පාන',icon:'🥤',retailPrice:185,wholesalePrice:157,costPrice:138,stock:950,lowStock:20,image:null},
    {name:'පාන-🥤-016',category:'පාන',icon:'🥤',retailPrice:190,wholesalePrice:161,costPrice:142,stock:980,lowStock:20,image:null},
    {name:'පාන-🥤-017',category:'පාන',icon:'🥤',retailPrice:195,wholesalePrice:165,costPrice:146,stock:1010,lowStock:20,image:null},
    {name:'පාන-🥤-018',category:'පාන',icon:'🥤',retailPrice:200,wholesalePrice:170,costPrice:150,stock:1040,lowStock:20,image:null},
    {name:'පාන-🥤-019',category:'පාන',icon:'🥤',retailPrice:205,wholesalePrice:174,costPrice:153,stock:1070,lowStock:20,image:null},
    {name:'පාන-🥤-020',category:'පාන',icon:'🥤',retailPrice:210,wholesalePrice:178,costPrice:157,stock:1100,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-001',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:170,wholesalePrice:144,costPrice:127,stock:530,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-002',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:175,wholesalePrice:148,costPrice:131,stock:560,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-003',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:180,wholesalePrice:153,costPrice:135,stock:590,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-004',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:185,wholesalePrice:157,costPrice:138,stock:620,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-005',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:190,wholesalePrice:161,costPrice:142,stock:650,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-006',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:195,wholesalePrice:165,costPrice:146,stock:680,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-007',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:200,wholesalePrice:170,costPrice:150,stock:710,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-008',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:205,wholesalePrice:174,costPrice:153,stock:740,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-009',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:210,wholesalePrice:178,costPrice:157,stock:770,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-010',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:215,wholesalePrice:182,costPrice:161,stock:800,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-011',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:220,wholesalePrice:187,costPrice:165,stock:830,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-012',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:225,wholesalePrice:191,costPrice:168,stock:860,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-013',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:230,wholesalePrice:195,costPrice:172,stock:890,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-014',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:235,wholesalePrice:199,costPrice:176,stock:920,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-015',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:240,wholesalePrice:204,costPrice:180,stock:950,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-016',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:245,wholesalePrice:208,costPrice:183,stock:980,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-017',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:250,wholesalePrice:212,costPrice:187,stock:1010,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-018',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:255,wholesalePrice:216,costPrice:191,stock:1040,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-019',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:260,wholesalePrice:221,costPrice:195,stock:1070,lowStock:20,image:null},
    {name:'ශ්‍රී -🌿-020',category:'ශ්‍රී ලාංකීය',icon:'🌿',retailPrice:265,wholesalePrice:225,costPrice:198,stock:1100,lowStock:20,image:null},
    {name:'එළවළු-🥬-001',category:'එළවළු',icon:'🥬',retailPrice:100,wholesalePrice:85,costPrice:75,stock:530,lowStock:20,image:null},
    {name:'එළවළු-🥬-002',category:'එළවළු',icon:'🥬',retailPrice:105,wholesalePrice:89,costPrice:78,stock:560,lowStock:20,image:null},
    {name:'එළවළු-🥬-003',category:'එළවළු',icon:'🥬',retailPrice:110,wholesalePrice:93,costPrice:82,stock:590,lowStock:20,image:null},
    {name:'එළවළු-🥬-004',category:'එළවළු',icon:'🥬',retailPrice:115,wholesalePrice:97,costPrice:86,stock:620,lowStock:20,image:null},
    {name:'එළවළු-🥬-005',category:'එළවළු',icon:'🥬',retailPrice:120,wholesalePrice:102,costPrice:90,stock:650,lowStock:20,image:null},
    {name:'එළවළු-🥬-006',category:'එළවළු',icon:'🥬',retailPrice:125,wholesalePrice:106,costPrice:93,stock:680,lowStock:20,image:null},
    {name:'එළවළු-🥬-007',category:'එළවළු',icon:'🥬',retailPrice:130,wholesalePrice:110,costPrice:97,stock:710,lowStock:20,image:null},
    {name:'එළවළු-🥬-008',category:'එළවළු',icon:'🥬',retailPrice:135,wholesalePrice:114,costPrice:101,stock:740,lowStock:20,image:null},
    {name:'එළවළු-🥬-009',category:'එළවළු',icon:'🥬',retailPrice:140,wholesalePrice:119,costPrice:105,stock:770,lowStock:20,image:null},
    {name:'එළවළු-🥬-010',category:'එළවළු',icon:'🥬',retailPrice:145,wholesalePrice:123,costPrice:108,stock:800,lowStock:20,image:null},
    {name:'එළවළු-🥬-011',category:'එළවළු',icon:'🥬',retailPrice:150,wholesalePrice:127,costPrice:112,stock:830,lowStock:20,image:null},
    {name:'එළවළු-🥬-012',category:'එළවළු',icon:'🥬',retailPrice:155,wholesalePrice:131,costPrice:116,stock:860,lowStock:20,image:null},
    {name:'එළවළු-🥬-013',category:'එළවළු',icon:'🥬',retailPrice:160,wholesalePrice:136,costPrice:120,stock:890,lowStock:20,image:null},
    {name:'එළවළු-🥬-014',category:'එළවළු',icon:'🥬',retailPrice:165,wholesalePrice:140,costPrice:123,stock:920,lowStock:20,image:null},
    {name:'එළවළු-🥬-015',category:'එළවළු',icon:'🥬',retailPrice:170,wholesalePrice:144,costPrice:127,stock:950,lowStock:20,image:null},
    {name:'එළවළු-🥬-016',category:'එළවළු',icon:'🥬',retailPrice:175,wholesalePrice:148,costPrice:131,stock:980,lowStock:20,image:null},
    {name:'එළවළු-🥬-017',category:'එළවළු',icon:'🥬',retailPrice:180,wholesalePrice:153,costPrice:135,stock:1010,lowStock:20,image:null},
    {name:'එළවළු-🥬-018',category:'එළවළු',icon:'🥬',retailPrice:185,wholesalePrice:157,costPrice:138,stock:1040,lowStock:20,image:null},
    {name:'එළවළු-🥬-019',category:'එළවළු',icon:'🥬',retailPrice:190,wholesalePrice:161,costPrice:142,stock:1070,lowStock:20,image:null},
    {name:'එළවළු-🥬-020',category:'එළවළු',icon:'🥬',retailPrice:195,wholesalePrice:165,costPrice:146,stock:1100,lowStock:20,image:null},
    {name:'පළතුරු-🍎-001',category:'පළතුරු',icon:'🍎',retailPrice:185,wholesalePrice:157,costPrice:138,stock:530,lowStock:20,image:null},
    {name:'පළතුරු-🍎-002',category:'පළතුරු',icon:'🍎',retailPrice:190,wholesalePrice:161,costPrice:142,stock:560,lowStock:20,image:null},
    {name:'පළතුරු-🍎-003',category:'පළතුරු',icon:'🍎',retailPrice:195,wholesalePrice:165,costPrice:146,stock:590,lowStock:20,image:null},
    {name:'පළතුරු-🍎-004',category:'පළතුරු',icon:'🍎',retailPrice:200,wholesalePrice:170,costPrice:150,stock:620,lowStock:20,image:null},
    {name:'පළතුරු-🍎-005',category:'පළතුරු',icon:'🍎',retailPrice:205,wholesalePrice:174,costPrice:153,stock:650,lowStock:20,image:null},
    {name:'පළතුරු-🍎-006',category:'පළතුරු',icon:'🍎',retailPrice:210,wholesalePrice:178,costPrice:157,stock:680,lowStock:20,image:null},
    {name:'පළතුරු-🍎-007',category:'පළතුරු',icon:'🍎',retailPrice:215,wholesalePrice:182,costPrice:161,stock:710,lowStock:20,image:null},
    {name:'පළතුරු-🍎-008',category:'පළතුරු',icon:'🍎',retailPrice:220,wholesalePrice:187,costPrice:165,stock:740,lowStock:20,image:null},
    {name:'පළතුරු-🍎-009',category:'පළතුරු',icon:'🍎',retailPrice:225,wholesalePrice:191,costPrice:168,stock:770,lowStock:20,image:null},
    {name:'පළතුරු-🍎-010',category:'පළතුරු',icon:'🍎',retailPrice:230,wholesalePrice:195,costPrice:172,stock:800,lowStock:20,image:null},
    {name:'පළතුරු-🍎-011',category:'පළතුරු',icon:'🍎',retailPrice:235,wholesalePrice:199,costPrice:176,stock:830,lowStock:20,image:null},
    {name:'පළතුරු-🍎-012',category:'පළතුරු',icon:'🍎',retailPrice:240,wholesalePrice:204,costPrice:180,stock:860,lowStock:20,image:null},
    {name:'පළතුරු-🍎-013',category:'පළතුරු',icon:'🍎',retailPrice:245,wholesalePrice:208,costPrice:183,stock:890,lowStock:20,image:null},
    {name:'පළතුරු-🍎-014',category:'පළතුරු',icon:'🍎',retailPrice:250,wholesalePrice:212,costPrice:187,stock:920,lowStock:20,image:null},
    {name:'පළතුරු-🍎-015',category:'පළතුරු',icon:'🍎',retailPrice:255,wholesalePrice:216,costPrice:191,stock:950,lowStock:20,image:null},
    {name:'පළතුරු-🍎-016',category:'පළතුරු',icon:'🍎',retailPrice:260,wholesalePrice:221,costPrice:195,stock:980,lowStock:20,image:null},
    {name:'පළතුරු-🍎-017',category:'පළතුරු',icon:'🍎',retailPrice:265,wholesalePrice:225,costPrice:198,stock:1010,lowStock:20,image:null},
    {name:'පළතුරු-🍎-018',category:'පළතුරු',icon:'🍎',retailPrice:270,wholesalePrice:229,costPrice:202,stock:1040,lowStock:20,image:null},
    {name:'පළතුරු-🍎-019',category:'පළතුරු',icon:'🍎',retailPrice:275,wholesalePrice:233,costPrice:206,stock:1070,lowStock:20,image:null},
    {name:'පළතුරු-🍎-020',category:'පළතුරු',icon:'🍎',retailPrice:280,wholesalePrice:238,costPrice:210,stock:1100,lowStock:20,image:null},
    {name:'ශ්‍රී ලාංකීය සුවිශේෂ නිෂ්පාදනය',category:'ශ්‍රී ලාංකීය',icon:'🇱🇰',retailPrice:250,wholesalePrice:212,costPrice:185,stock:1000,lowStock:50,image:null}
  ];
...
// Force reseed products (adds missing Sinhala catalogue)
async function reseedProducts(){
  if(!confirm('⚠️ දැනට ඇති නිෂ්පාදන ඉවත් නොකෙරේ. නව Sinhala catalogue (1000 items) එකතු කෙරේ. Continue?')) return;
  const existing = await ga('products');
...
const ps=[
  ...
  await loadAll();
  renderProds();
  toast(`✓ ${added} නව නිෂ්පාදන catalog-ට එකතු කළා!`,'success');
}
